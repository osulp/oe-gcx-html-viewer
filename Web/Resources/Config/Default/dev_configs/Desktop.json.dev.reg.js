        ...
        "modules": [
            ...
            },
          {
            ...
            },
            {
                ...
                "moduleType": "oe.dev_registry.DevelopmentRegistryModule",
                "libraryId": "Custom",
                "configuration": {
                    "adminGroupID": "f1f343e0846d4f7c8b1c74e2af5f597b",
                    "publicViewerTitle": "Sage-Grouse Development Registry Viewer",
                    "editorViewerTitle": "Sage-Grosue Development Registry Editor",
                    "productionAgolUrl": "http://services.arcgis.com/uUvqNMGPm7axC2dD/arcgis/rest/services/Oregon_Sage_Grouse_Development_Registry/FeatureServer/0",
                    "devAgolUrl": "http://services.arcgis.com/uUvqNMGPm7axC2dD/arcgis/rest/services/osgdr_dev/FeatureServer/0",
                    "largeScaleText": "Large-scale development means uses that are: over 50 feet in height; have a direct impact in excess of five acres; generate more than 50 vehicle trips per day; or create noise levels of at least 70 dB at zero meters for sustained periods of time. Uses that constitute large-scale development also require review by county decision makers and are listed in one of the following categories identified in the table attached to OAR 660-033-0120. (A) Commercial Uses.  (B) Mineral, Aggregate, Oil and Gas Uses. (C) Transportation Uses. (D) Utility/Solid Waste Disposal Facilities. (E) Parks/Public/Quasi-Public.",
                    "lineBufferSubCats":["Above Ground Power Line","Temporary Road","Access Road","Surface Street","Major Road","Interstate Highway","Mainline","Spur"],
                    "lineBufferCategories":["Infrastructure (Powerline)", "Infrastructure (Road)", "Infrastructure (Railroad)", "Infrastructure (Pipeline)"],
                    "adminHomePanleContent": "%3Cdiv%20style%3D%22text-align%3A%20center%3B%20padding%3A%2020px%3B%20font-family%3A%20Segoe%20UI%20Light%2C%20Segoe%20UI%2C%20Arial%3B%22%3E%3Cspan%20style%3D%22font-weight%3A%20bold%3B%22%3E%3Cfont%20size%3D%223%22%3ESage%20Grouse%20Development%20Registry%3Cbr%3E%3Cbr%3E%3C%2Ffont%3E%3C%2Fspan%3E%3Cdiv%20style%3D%22text-align%3A%20left%3B%22%3E%3Cfont%20size%3D%221%22%3E%3Cfont%20size%3D%222%22%3EThis%20tool%20allows%20you%20to%20find%20developments%20in%20Priority%20Areas%20of%20Conservation%20(PACs)%20for%20Sage%20Grouse.%26nbsp%3B%20%3Cbr%3E%3Cbr%3ETo%20get%20a%20report%20for%20a%20PAC%2C%20either%20click%20on%20a%20PAC%20and%20select%20the%20link%20to%20run%20a%20report%2C%20or%20click%20the%20Development%20Report%20tool%20in%20the%20toolbar.%26nbsp%3B%20%3Cbr%3E%3Cbr%3ETo%20enter%20new%20developments%20or%20modify%20existing%20ones%2C%20you%20need%20to%20sign%20in%20to%20the%20tool.%26nbsp%3B%20The%20sign%20in%20link%20is%20by%20the%20search%20box%20in%20the%20upper%20right%20corner.%3Cbr%3E%3Cbr%3EFor%20questions%20or%20comments%2C%20contact%20%7B%7D.%3C%2Ffont%3E%3Cbr%3E%26nbsp%3B%3C%2Ffont%3E%3Cbr%3E%3Cspan%20style%3D%22font-weight%3A%20bold%3B%22%3E%3C%2Fspan%3E%3C%2Fdiv%3E%3C%2Fdiv%3E",
                    "layerFilters": {
                        "Default": [
                          "dst_cat",
                          "dst_nm",
                ...
                "views": [
                 {
                     ...
                     "type": "oe.dev_registry.DevelopmentRegistryModuleView",
                     "region": "DataRegion",
                     "configuration": {}
                 },
                 {
                     "id": "DevelopmentRegistryModuleProjectReportView",
                     "title": "Project Impact Report",
                     "viewModelId": "DevelopmentRegistryModuleProjectReportViewModel",
                     "visible": false,
                     "markup": "Modules/DevelopmentRegistry/DevelopmentRegistryModuleProjectReportView.html",
                     "type": "oe.dev_registry.DevelopmentRegistryModuleProjectReportView",
                     "region": "DataRegion",
                     "configuration": {}
                 }
                ],
                "viewModels": [
                  {
                      ...
                      "type": "oe.dev_registry.DevelopmentRegistryModuleViewModel",
                      "configuration": {}
                  },
                  {
                      "id": "DevelopmentRegistryModuleProjectReportViewModel",
                      "type": "oe.dev_registry.DevelopmentRegistryModuleProjectReportViewModel",
                      "configuration": {}
                  }
                ]
            },
            ...
            },
            {
                ...
                "configuration": {
                    ...
                    "measurementProjectionWkid": "2992",
                    "measurementLengthUnits": "feet",
                    "measurementAreaUnits": "acre",
                    "coordinateFractionalDigits": 4,
            ...
            },
            {
                ...
                "configuration": {
                    "siteUri": "http://tools.oregonexplorer.info/Geocortex/Essentials/agol/REST/sites/dev_reg",
            ...
            },
            {
                                      ...
                                      "items": [
                                        ...
                                        },
                                        {
                                        ...
                                        },
                                         {
                                             ...
                                             "commandParameter": "http://oe.oregonexplorer.info/ExternalContent/DevelopmentRegistry/Registry_UserGuide_September2017.pdf ",
                                             "hideOnDisable": true,
                                             "name": "User Guide",
                                             "tooltip": "Assign Large Scale to Federal Development Projects"
                                         }
                                  ...
                                  },
                {
                    "id": "RgU4xKTu",
                    "type": "toolbarGroup",
                    "name": "Development Registry Reports",
                    "layout": "Large",
                    "items": [
                      {
                          "id": "KZQUM1m2",
