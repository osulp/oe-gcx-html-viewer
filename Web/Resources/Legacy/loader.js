    ...
    (function (framework) {
        ...
        (function (application) {
            ...
            (function (resources) {
                ...
                })(resources.ResourceStatus || (resources.ResourceStatus = {}));
                var ResourceStatus = resources.ResourceStatus;
    ...
    (function (framework) {
        ...
        (function (application) {
            ...
            (function (resources) {
                ...
                })(resources.ScriptLoadingMode || (resources.ScriptLoadingMode = {}));
                var ScriptLoadingMode = resources.ScriptLoadingMode;
                /**
    ...
    (function (essentialsHtmlViewer) {
        ...
        var ViewerLoader = (function (_super) {
            ...
            function ViewerLoader(options) {
                ...
                this.aliases = new geocortex.framework.application.loading.CaselessMap();
                ...
                this.resourceSet.append([
                    ...
                    },
                    {
                        name: "viewer",
                        resources: [
                            loaderResourcePrefix + "Resources/Compiled/Framework.js",
                            loaderResourcePrefix + "Resources/Compiled/Framework.UI.js",
                            loaderResourcePrefix + "Resources/Compiled/Charting.Infrastructure.js",
                            loaderResourcePrefix + "Resources/Compiled/Essentials.js",
                            loaderResourcePrefix + "Resources/Compiled/Mapping.Infrastructure.js",
                            loaderResourcePrefix + "Resources/Scripts/Insight.EventRelay.js",
                            loaderResourcePrefix + "Resources/Scripts/Bridge.js",
                            loaderResourcePrefix + "Resources/Scripts/moment/moment-timezone-with-data.js"
                        ]
                    }
                ]);
                if (typeof WeakMap !== "function") {
                    this.resourceSet.find("tools").append([loaderResourcePrefix + "Resources/Scripts/weakmap.js"]);
                }
                var documentMode = document.documentMode;
                // If IE8-
                if (documentMode && documentMode <= 8) {
                    this.resourceSet.find("css").prepend([loaderResourcePrefix + "Resources/Styles/IE.css"]);
                }
                // If IE9-
                if (documentMode && documentMode <= 9) {
                    this.resourceSet.find("tools").append([loaderResourcePrefix + "Resources/Scripts/jquery.iframe-transport-1.0.0.min.js"]);
                }
                // If IE10+
                if (!documentMode || (documentMode && documentMode >= 10)) {
                    this.resourceSet.find("tools").append([loaderResourcePrefix + "Resources/Scripts/hammer.js"]);
                }
            }
            /**
            ...
            ViewerLoader.prototype.obtainConfigFromAlias = function (options, onSuccess, onError) {
                ...
                if (viewerConfig && viewerConfig.viewerConfigUri) {
                    ...
                    this.getViewerSettingsFromJson(function (json) {
                        // Early browsers don't support String.prototype.startsWith(), and we have not yet
                        // loaded Framework, so we have to make our own cross-browser solution.
                        var stringStartsWith = function (str, beg) { return str.indexOf(beg) === 0; };
                        var hasToken = location.hash.length != 0 && stringStartsWith(location.hash, "#gcx-");
            ...
            ViewerLoader.prototype.loadAndInitialize = function (options) {
                ...
                this.resourceSet.find("dependencies").load({
                    onLoaded: function () {
                        ...
                        // When dojo is ready, load the "require" set, followed by the "viewer" set.
                        dojo.ready(function () {
                            _this.resourceSet.find("viewer").load({
                                onLoaded: function () {
            ...
            ViewerLoader.prototype.resolveSplashScreenUrl = function (baseUrl, splashScreenUrl) {
                ...
                if (r.test(splashScreenUrl)) {
                    ...
                    var stringToFind = "REST/";
                    var index = baseUrl.indexOf(stringToFind);
                    if (index >= 0) {
            ...
            ViewerLoader.prototype.getConfigBaseFromEndpoints = function (endpointParams) {
                ...
                if (index === endpoints.length) {
                    ...
                    // Early browsers don't support String.prototype.endsWith(), and we have not yet
                    // loaded Framework, so we have to make our own cross-browser solution.
                    var stringEndsWith = function (str, end) { return str.lastIndexOf(end) === str.length - end.length; };
                    // Extract the endpoint's path and ensure it is suffix with a '/'.
                    var endpointUrl = String(endpoints[index]["externalUrl"]);
                    if (stringEndsWith(endpointUrl, "/") || stringEndsWith(endpointUrl, "\\")) {
                    ...
                    getJson(endpointUrl + alias + "?f=json", function (json) {
                        ...
                        if (stringEndsWith(configStem, "/") || stringEndsWith(configStem, "\\")) {
