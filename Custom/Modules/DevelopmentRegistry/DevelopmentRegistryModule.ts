...
module oe.dev_registry {
    ...
    export class DevelopmentRegistryModule extends geocortex.framework.application.ModuleBase {
        ...
        _handleMeasureArea() {
            let clonedGraphics = geocortex.essentialsHtmlViewer.mapping.infrastructure.GraphicUtils.getGraphicsLayer("editor_clone_layer", false, this.app);
            let editingLayer = geocortex.essentialsHtmlViewer.mapping.infrastructure.GraphicUtils.getGraphicsLayer("editing_layer", false, this.app);
            ...
            if (isAuthenticated) {
                ...
                try {
                    ...
                    this.app.commandRegistry.command("oe_delete_measurement").register(this, (graphic) => {
                        ...
                        let measureGraphic = geocortex.essentialsHtmlViewer.mapping.infrastructure.GraphicUtils.getGraphicsLayer("Drawings_measurement", false, this.app);
                        if (measureGraphic) {
                        ...
                        //can execute?
                        let canShow = false;
                        let measureLayer = geocortex.essentialsHtmlViewer.mapping.infrastructure.GraphicUtils.getGraphicsLayer("Drawings_measurement", false, this.app);
                        if (measureLayer) {
