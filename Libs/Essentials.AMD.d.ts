...
declare module "geocortex/config" {
/** @docs-hide-from-nav */
...
export const config: EssentialsConfig;
 ...
 */
export function getElement(xmlDoc: Element, elementName: string): Element;
/**
 * Return the text content of a child element named elementName.
 * @param XmlNode The xml node to use to find the element with name elementName.
 * @param String The name of the element to get the text content from.
 */
export function getElementText(xmlDoc: Element, elementName: string): string;
/**
 ...
 */
export function getAttributeValue(xmlDoc: Node, attributeName: string): string;
/** @private */
export function _parseBoolean(value: string): boolean;
export function renderFormItem(fromItem: any): Node;

}
declare module "geocortex/geocortex" {
import { Extension } from "geocortex/essentials/Extension";
/**
 ...
 */
export function deferredResolve(def: dojo.Deferred, result: any): void;
/**
 ...
 */
export function deferredReject(def: dojo.Deferred, result: any): void;
/**
 ...
 */
export function encodeJson(objectToEncode: Object): Object;
/**
 ...
 */
export function request(request: RequestObject, options?: RequestOptions): any;
/**
 ...
 */
export function requiresProxy(request: RequestObject): boolean;
/**
 ...
 */
export function urlToQueryObject(url: string): Object;
/**
...
/** @private */
export function _getExtensions(extensions: ExtensionParam[]): Extension[];
/** @private */
export function _extensionsToJson(extensions: Extension[]): ExtensionParam[];
/** @docs-hide-from-nav */
...
/** @private */
export function _getProperties(properties: PropertyParam[]): any;
/** @private */
export function _propertiesToJson(properties: any): PropertyParam[];

}
declare module "geocortex/hasProxy" {
/**
 * Detects whether or not a proxy URL has been configured on the global ArcGIS JSAPI configuration object.
 */
...
declare module "geocortex/essentials/ArcGisPortalSecurityContext" {
import { TokenResult } from "geocortex/essentials/TokenResult";
import { OAuth2Error } from "geocortex/essentials/OAuth2Client";
/**
 ...
 */
export class ArcGisPortalSecurityContext {
...
declare module "geocortex/essentials/AsyncInitializable" {
import { Site } from "geocortex/essentials/Site";
export interface SiteInterface extends Site {
}
/**
...
*/
export class AsyncInitializable {
...
declare module "geocortex/essentials/AuthenticationControlBlock" {
/**
 ...
 * @deprecated 2.8
 */
export class AuthenticationControlBlock {
...
declare module "geocortex/essentials/AuthenticationControlBlockStore" {
import { AuthenticationControlBlock } from "geocortex/essentials/AuthenticationControlBlock";
/**
 ...
 * @deprecated 2.8
 */
export class AuthenticationControlBlockStore {
...
declare module "geocortex/essentials/BaseMap" {
import { Map } from "geocortex/essentials/Map";
import { Extension } from "geocortex/essentials/Extension";
import { BaseMapService } from "geocortex/essentials/BaseMapService";
/**
...
declare module "geocortex/essentials/BaseMapService" {
...
declare module "geocortex/essentials/DataLink" {
import { AsyncInitializable } from "geocortex/essentials/AsyncInitializable";
import { Extension } from "geocortex/essentials/Extension";
import { Layer } from "geocortex/essentials/Layer";
import { DataLinkParameter } from "geocortex/essentials/DataLinkParameter";
import { DataLinkSearch } from "geocortex/essentials/DataLinkSearch";
/**
 ...
 */
export class DataLink extends AsyncInitializable {
    /** The display name. */
    displayName: string;
    /**
...
declare module "geocortex/essentials/DataLinkSearch" {
 ...
 */
export interface DataLinkSearch {
...
declare module "geocortex/essentials/DistanceUnit" {
/**
 ...
 */
export module DistanceUnitType {
    var OTHER: string;
    var INCHES: string;
    var FEET: string;
...
declare module "geocortex/essentials/EssentialsFeatureSet" {
import { EssentialsLayerInfo } from "geocortex/essentials/EssentialsLayerInfo";
/**
 * Represents information about an Essentials FeatureSet for json serialization purposes.
 */
export class EssentialsFeatureSet {
    /** The featureSet id. */
    featureSetId: string;
    /** The featureSet display name. */
    featureSetDisplayName: string;
    /** The layerInfo. */
    layerInfo: EssentialsLayerInfo;
    /** The esri FeatureSet. */
    esriFeatureSet: any;
    toJson(): any;
}
...
declare module "geocortex/essentials/EssentialsLayerInfo" {
/**
 * Represents information about an Essentials {@link Layer}.
 */
export class EssentialsLayerInfo {
...
declare module "geocortex/essentials/ExportMapImageOptions" {
/**
 * An object that represents the options for exporting the map image.
 */
export class ExportMapImageOptions {
...
declare module "geocortex/essentials/Extension" {
/**
...
declare module "geocortex/essentials/ExtentManager" {
/**
...
export class ExtentManager {
    ...
    private _setInitialExtentImplWithPromise(initialExtent);
     ...
     */
    changeExtentWithPriority(extentChangeFunction: (map: esri.Map) => Promise<void>, priority?: number): void;
    /**
...
declare module "geocortex/essentials/FeatureCluster" {
/**
...
declare module "geocortex/essentials/FeatureHeatMap" {
/**
...
declare module "geocortex/essentials/FeatureHyperlink" {
import { Layer } from "geocortex/essentials/Layer";
/**
 * Represents a FeatureHyperlink configured on a layer by an Administrator.
 */
export class FeatureHyperlink {
...
declare module "geocortex/essentials/FeatureLayerService" {
import { MapService } from "geocortex/essentials/MapService";
/**
 ...
 */
export class FeatureLayerService extends MapService {
...
declare module "geocortex/essentials/Field" {
import { Layer } from "geocortex/essentials/Layer";
export class EsriFieldTypes {
...
export class EssentialsFieldTypes {
...
declare module "geocortex/essentials/GeocodingEndpoint" {
import { PropertyParam, ExtensionParam } from "geocortex/geocortex";
import { AsyncInitializable } from "geocortex/essentials/AsyncInitializable";
import { Extension } from "geocortex/essentials/Extension";
import { Site } from "geocortex/essentials/Site";
export interface GeocodingEndpointResponse {
    id: string;
    displayName: string;
    serviceType: string;
    ...
    extensions: ExtensionParam[];
    globalSearchKey: string;
    parameters: GeocodingEndpointParameter[];
}
export interface GeocodingEndpointParameter {
    name: string;
    displayName: string;
    value: string;
    isRequired: boolean;
...
export class GeocodingEndpoint extends AsyncInitializable {
    /**
...
export module GeocodingEndpointType {
    const ARCGIS_GEOCODER: string;
    const BING_GEOCODER: string;
}

}
declare module "geocortex/essentials/GeometryEndpoint" {
import { AsyncInitializable } from "geocortex/essentials/AsyncInitializable";
import { Extension } from "geocortex/essentials/Extension";
import { Site } from "geocortex/essentials/Site";
/**
 ...
 */
export class GeometryEndpoint extends AsyncInitializable {
...
export module GeometryEndpointType {
 ...
 */
export function spatialRefsAreEqual(ref1: esri.SpatialReference, ref2: esri.SpatialReference, ignoreNulls?: boolean): boolean;
/**
 * Compares two envelopes for spatial equality.
 * @param env1 Envelope A.
 * @param env2 Envelope B.
 */
export function envelopesAreEqual(envelope1: esri.geometry.Extent, envelope2: esri.geometry.Extent): boolean;
/**
 ...
 */
export function getExtent(geometries: esri.geometry.Geometry[]): esri.geometry.Extent;
/**
 * Creates a polygon representing the given extent.
 * @param envelope The envelope to turn into a polygon.
 */
export function envelopeToPolygon(envelope: esri.geometry.Extent): esri.geometry.Polygon;
/**
 ...
 */
export function isSelfIntersectingPolygon(poly: esri.geometry.Polygon): boolean;
/**
 * Checks whether or not a polygon is convex.
 * @param geometry The geometry to check.
 */
export function isConvex(poly: esri.geometry.Polygon): boolean;
/**
 * Checks whether or not a point lies in an Envelope.
 * @param point The point to check.
 * @param envelope The envelope to check.
 */
export function pointInEnvelope(point: esri.geometry.Point, envelope: esri.geometry.Extent): boolean;
/**
 ...
 */
export function clipEnvelope(envelopeToClip: esri.geometry.Extent, clipAgainst: esri.geometry.Extent): esri.geometry.Extent;
/**
 ...
 */
export function scaleEnvelope(envelope: esri.geometry.Extent, scaleX: number, scaleY: number): esri.geometry.Extent;
/**
 ...
 */
export function scaleEnvelopeWithoutTranslation(envelope: esri.geometry.Extent, scaleFactor: number): esri.geometry.Extent;
/**
 * Computes the Cartesian distance between two points.
 * @param point1 The first point.
 * @param point2 The second point.
 */
export function computeDistance(point1: esri.geometry.Point, point2: esri.geometry.Point): number;
/**
 * Returns an extent that represents the provided envelope scaled by the given amounts on each axis.
 ...
 */
export function translateEnvelope(envelope: esri.geometry.Extent, translateX: number, translateY: number): esri.geometry.Extent;
/**
 * Calculates the length of a vector.
 * @param vector The vector to calculate length for.
 */
export function length(vector: esri.geometry.Point): number;
/**
 * Returns a normalized vector.
 * @param vector The vector to normalize.
 */
export function normalize(vector: esri.geometry.Point): esri.geometry.Point;
/**
 * Calculates the angle (in Radians) between two vectors.
 * @param a The first vector.
 * @param b The second vector.
 */
export function angle(a: esri.geometry.Point, b: esri.geometry.Point): number;
/**
 ...
 */
export function crossProduct(a: esri.geometry.Point, b: esri.geometry.Point, origin?: esri.geometry.Point): number;
/**
 * Calculates the 2D cross product of two vectors.
 * @param a The first vector.
 * @param b The second vector.
 * @param origin The origin by which these vectors relate.
 */
export function crossProductArray(a: number[], b: number[], origin?: number[]): number;
/**
 * Calculates the dot product of two vectors.
 * @param a The first vector.
 * @param b The second vector.
 */
export function dotProduct(a: esri.geometry.Point, b: esri.geometry.Point): number;
/**
 * Calculates the approximate midpoint of a collection of points.
 * @param points The array of points.
 */
export function polygonMidpoint(points: esri.geometry.Point[]): esri.geometry.Point;

}
declare module "geocortex/essentials/GeoprocessingEndpoint" {
import { AsyncInitializable } from "geocortex/essentials/AsyncInitializable";
import { Extension } from "geocortex/essentials/Extension";
import { Site } from "geocortex/essentials/Site";
import { PropertyParam, ExtensionParam } from "geocortex/geocortex";
export class GeoprocessingEndpoint extends AsyncInitializable {
...
/** @private */
export module GeoprocessingEndpointType {
    const ARCGIS_GEOPROCESSOR: string;
}

}
declare module "geocortex/essentials/GeoRssLayerService" {
import { MapService } from "geocortex/essentials/MapService";
/**
 ...
 */
export class GeoRssLayerService extends MapService {
    /**
...
declare module "geocortex/essentials/KmlService" {
import { MapService } from "geocortex/essentials/MapService";
/**
 ...
 */
export class KmlService extends MapService {
...
declare module "geocortex/essentials/Layer" {
import { AsyncInitializable } from "geocortex/essentials/AsyncInitializable";
import { LayerChart } from "geocortex/essentials/LayerChart";
import { DataLink } from "geocortex/essentials/DataLink";
import { Field } from "geocortex/essentials/Field";
import { Extension } from "geocortex/essentials/Extension";
import { FeatureHyperlink } from "geocortex/essentials/FeatureHyperlink";
import { LayerHyperlink } from "geocortex/essentials/LayerHyperlink";
import { MapService } from "geocortex/essentials/MapService";
import { Report } from "geocortex/essentials/Report";
import { LayerStyle } from "geocortex/essentials/LayerStyle";
import { LayerQuery } from "geocortex/essentials/LayerQuery";
import { RefreshVisibility } from "geocortex/essentials/RefreshVisibility";
import { LayerThemeSetting } from "geocortex/essentials/LayerThemeSetting";
import { TimeInfo } from "geocortex/essentials/TimeInfo";
 ...
 */
export class Layer extends AsyncInitializable {
    ...
    wmsLayerName: string;
    /**
    * The name of the WFS layer. This is the actual layer name from the capabilities, unlike
    * the name property of this Layer which is actually the title in the capabilities.
    */
    wfsLayerName: string;
    /**
...
declare module "geocortex/essentials/LayerCatalog" {
/**
...
declare module "geocortex/essentials/LayerChart" {
...
declare module "geocortex/essentials/LayerHyperlink" {
import { MapService } from "geocortex/essentials/MapService";
import { Layer } from "geocortex/essentials/Layer";
export interface LayerHyperLinkMapService extends MapService {
}
export interface LayerHyperLinkLayer extends Layer {
}
/**
 * Client representation of a layer hyperlink object attached to a layer.
 */
export class LayerHyperlink {
    /** Whether to URL encode replacement values in the uri property. */
    encodeUriReplacementValues: boolean;
    /** The URI of an image which represents the hyperlink being generated. */
    iconUri: string;
...
declare module "geocortex/essentials/LayerQuery" {
/**
 *  The base class for query items.
 */
export interface LayerQueryItem {
}
/**
 *  Represents a group in a layer query.
 */
export interface LayerQueryGroup extends LayerQueryItem {
    /** The conjunction that joins the query items of this group. For example: AND, OR. */
    conjunction: string;
    /** The items. */
    items: LayerQueryItem[];
}
/**
 *  Represents a clause in a layer query.
 */
export interface LayerQueryClause extends LayerQueryItem {
    /** The field. */
    field: string;
    /** The operator. */
    operator: string;
...
export class LayerQuery {
    ...
    query: LayerQueryGroup;
    /**
     * Initializes a new instance of the {@link LayerQuery} class.
     * @param layerQueryInfo Values used to populate the members of this object.
     */
    constructor(layerQueryInfo?: {
        id: string;
        displayName: string;
        query: LayerQueryGroup;
    });
...
declare module "geocortex/essentials/LayerStyle" {
/**
...
declare module "geocortex/essentials/LayerTheme" {
import { Extension } from "geocortex/essentials/Extension";
import { PropertyParam } from "geocortex/geocortex";
import { LayerThemesInfo } from "geocortex/essentials/LayerThemesInfo";
/**
...
declare module "geocortex/essentials/LayerThemeEventArgs" {
import { LayerTheme } from "geocortex/essentials/LayerTheme";
...
declare module "geocortex/essentials/LayerThemesInfo" {
import { Map } from "geocortex/essentials/Map";
import { LayerTheme } from "geocortex/essentials/LayerTheme";
...
declare module "geocortex/essentials/LayerTimeOptions" {
...
declare module "geocortex/essentials/LayerType" {
/**
...
declare module "geocortex/essentials/LayerVisibilityEventManager" {
import { MapService } from "geocortex/essentials/MapService";
/**
 * Manages layer visibilities and events.
 * @private
 */
export class LayerVisibilityEventManager {
    private _mapService;
    /**
...
declare module "geocortex/essentials/Map" {
import { AsyncInitializable } from "geocortex/essentials/AsyncInitializable";
import { BaseMap } from "geocortex/essentials/BaseMap";
import { MapService } from "geocortex/essentials/MapService";
import { LayerThemesInfo } from "geocortex/essentials/LayerThemesInfo";
import { ExportMapImageOptions } from "geocortex/essentials/ExportMapImageOptions";
import { DistanceUnit } from "geocortex/essentials/DistanceUnit";
import { ExtentManager } from "geocortex/essentials/ExtentManager";
import { Layer } from "geocortex/essentials/Layer";
import { ReportParameters } from "geocortex/essentials/ReportParameters";
export class Map extends AsyncInitializable {
    ...
    /**
     * The collection of layers that are in a suspended state.
     * Used during viewer initialization to prevent unnecessary network requests.
     */
    private _suspendedLayers;
    /**
    ...
    /**
     * Resume any layers that were previously suspended.
     */
    resumeSuspendedLayers(): void;
    /**
     ...
     */
    addMapService(mapService: MapService): void;
    /**
    ...
    _configureObject(obj: {
        ...
        fullExtent?: esri.geometry.Extent;
        units?: DistanceUnit;
        exportOptions?: ExportMapImageOptions;
     ...
     */
    findLayerFromMatchingEsriFeatureLayer(layer: esri.layers.FeatureLayer): Layer;
    /** @private */
...
declare module "geocortex/essentials/MapGrid" {
/**
...
declare module "geocortex/essentials/MapService" {
import { AsyncInitializable } from "geocortex/essentials/AsyncInitializable";
import { Extension } from "geocortex/essentials/Extension";
import { FeatureCluster } from "geocortex/essentials/FeatureCluster";
import { Layer } from "geocortex/essentials/Layer";
import { LayerThemeSetting } from "geocortex/essentials/LayerThemeSetting";
import { LayerHyperlink } from "geocortex/essentials/LayerHyperlink";
import { TimeInfo } from "geocortex/essentials/TimeInfo";
...
import { LayerTheme } from "geocortex/essentials/LayerTheme";
import { LayerCatalogDetail } from "geocortex/essentials/catalog/LayerCatalogDetail";
/**
 ...
 */
export class MapService extends AsyncInitializable {
    /**
     ...
     * For now this is just used for WMS and WFS. */
     ...
     * This has been modified in order to resolve issues like GVH-14376. Earlier, we used to get metadata for all layers and tables from the map server and the
     * rationale behind this was to avoid multiple requests for multiple layers that may be in the service. This is all good for services with a limited number of
     * layers but as demonstrated by GVH-14376, some clients add a lot of layers to a service, in which case, the request for all layers and tables will either take
     * a long time to resolve, or exceeds the maxJsonLength specification on the server, resulting in an error.
     * In the interests of both speed and minimal requests to the REST endpoint, this function now employs a hybrid approach:
     * 1) When the first request for a layer comes in, we request for (and cache) both the layer infos for that particular layer AS WELL as all layers and tables.
     * 2) When subsequent requests come in, we first check to see if the request we sent out previously for all layers and tables have resolved. If they have, we
     * use them, otherwise send out a fresh request for that particular layer.
     * The above approach ensures that if a service has 174 layers (real world example from GVH-14376), coded domain resolution will not fail even if the request for
     * layer definitions for all layers and tables fails because the response exceeds the value set on the maxJsonLength property on the server, we can still resolve them
     * on a layer by layer basis. However, if the request for all layers succeeds, then any subsequent reequests for layer infos will use that instead of trying to retrieve
     * layer infos on a case by case basis.
     */
    ...
    */
    ...
    private _addCredentialForLayer();
    private _updateCredentialForLayer();
    ...
    */
     ...
     */
    applyCatalogLayersChange(details: LayerCatalogDetail): Array<Layer>;
    /**
...
declare module "geocortex/essentials/MapServiceConstants" {
/**
* String constants that represent the various types of {@link MapService}.
*/
export module MapServiceType {
    ...
    const WMTS: string;
    const GEORSS: string;
    const WEBTILED: string;
    const VECTORTILE: string;
    const KML: string;
    const GRAPHICS: string;
    const LABEL: string;
    const STREAM: string;
    const CSV: string;
    const MAPIMAGE: string;
    const UNKNOWN: string;
}
/**
* String constants that represent the various functions of {@link MapService}.
*/
export module MapServiceFunction {
...
*/
export module DrawingBehavior {
    const MAP_SERVICE: string;
    const FEATURE_LAYER: string;
    const WFS_LAYER: string;
    const GEORSS_LAYER: string;
    const KML_SERVICE: string;
    const STREAM_LAYER: string;
}
/**
* String constants that represent various failure actions.
*/
export module FailureAction {
    const IGNORE: string;
    const WARN: string;
    const ERROR: string;
}
 ...
 */
export module UserLayerType {
    const LAYER_ADDITION = "LayerAddition";
    const LAYER_CATALOG = "LayerCatalog";
    const UPLOAD = "Upload";
}

}
declare module "geocortex/essentials/NamedExtent" {
import { AsyncInitializable } from "geocortex/essentials/AsyncInitializable";
import { Extension } from "geocortex/essentials/Extension";
import { Site } from "geocortex/essentials/Site";
/**
 ...
 */
export class NamedExtent extends AsyncInitializable {
...
declare module "geocortex/essentials/OAuth2Client" {
import { TokenResult } from "geocortex/essentials/TokenResult";
/**
...
declare module "geocortex/essentials/OfflineBasemap" {
/**
...
declare module "geocortex/essentials/Principal" {
/**
...
declare module "geocortex/essentials/PrintTemplate" {
import { AsyncInitializable } from "geocortex/essentials/AsyncInitializable";
import { Extension } from "geocortex/essentials/Extension";
import { Site } from "geocortex/essentials/Site";
import { Scale } from "geocortex/essentials/Scale";
import { Resolution } from "geocortex/essentials/Resolution";
import { TextField } from "geocortex/essentials/TextField";
import { MapGrid } from "geocortex/essentials/MapGrid";
import { ReportParameters } from "geocortex/essentials/ReportParameters";
export class PrintTemplate extends AsyncInitializable {
...
declare module "geocortex/essentials/RefreshVisibility" {
/**
* String constants that represent visibility settings for preserving user settings
*/
export class RefreshVisibility {
...
declare module "geocortex/essentials/Report" {
import { AsyncInitializable } from "geocortex/essentials/AsyncInitializable";
import { Extension } from "geocortex/essentials/Extension";
import { Layer } from "geocortex/essentials/Layer";
import { Scale } from "geocortex/essentials/Scale";
 ...
 */
export class Report extends AsyncInitializable {
...
export module ReportType {
    const LAYER_TEMPLATE_REPORT: string;
    const MAP_TEMPLATE_REPORT: string;
}

}
declare module "geocortex/essentials/ReportParameters" {
import { Map } from "geocortex/essentials/Map";
import { TextField } from "geocortex/essentials/TextField";
import { MapGrid } from "geocortex/essentials/MapGrid";
import { Resolution } from "geocortex/essentials/Resolution";
import { Scale } from "geocortex/essentials/Scale";
/** ESPORT2K16 */
export interface MapInterface extends Map {
}
/**
...
export class ReportParameters {
     ...
     */
    toJson(esriMap: esri.Map, essentialsMap: MapInterface): any;
    /**
...
declare module "geocortex/essentials/Resolution" {
/**
...
declare module "geocortex/essentials/RestEndpointResult" {
/**
 ...
 */
export class RestEndpointResult {
...
declare module "geocortex/essentials/RestHelper" {
import { Site } from "geocortex/essentials/Site";
/**
...
export class RestHelper {
     ...
     */
    static processClientSideTokens(site: Site, input: string): string;
    /**
...
declare module "geocortex/essentials/RestHelperHTTPService" {
import { TokenResult } from "geocortex/essentials/TokenResult";
/**
 ...
 */
export class RestHelperHTTPService {
    ...
    */
     ...
     * @deprecated 2.8
     */
    static getAuthenticationControlBlockStore(): any;
    /**
...
declare module "geocortex/essentials/RestUtility" {
import { RestEndpointResult } from "geocortex/essentials/RestEndpointResult";
/**
...
declare module "geocortex/essentials/Rx.light" {
/** @private */
/** @private */
...
/** @private */
export class AnonymousObservable implements IObservable<any> {
...
declare module "geocortex/essentials/Scale" {
/**
...
declare module "geocortex/essentials/SearchQuery" {
import { Layer } from "geocortex/essentials/Layer";
import { Map } from "geocortex/essentials/Map";
/**
...
declare module "geocortex/essentials/SearchResultFeature" {
import { Layer } from "geocortex/essentials/Layer";
/**
...
declare module "geocortex/essentials/SearchResults" {
import { SearchResultSet } from "geocortex/essentials/SearchResultSet";
import { SearchQuery } from "geocortex/essentials/SearchQuery";
/**
 * Represents the results of a Geocortex Search.
 */
...
declare module "geocortex/essentials/SearchResultSet" {
import { SearchResultFeature } from "geocortex/essentials/SearchResultFeature";
import { Layer } from "geocortex/essentials/Layer";
/**
...
declare module "geocortex/essentials/SearchTable" {
import { AsyncInitializable } from "geocortex/essentials/AsyncInitializable";
import { SearchTableParameter } from "geocortex/essentials/SearchTableParameter";
import { Site } from "geocortex/essentials/Site";
/**
 * Represents a Search Table defined by a {@link Site}.
 */
export class SearchTable extends AsyncInitializable {
...
declare module "geocortex/essentials/SearchTableParameter" {
/**
 * Represents a parameter in a {@link geocortex.essentials.SearchTable}.
 */
export class SearchTableParameter {
...
declare module "geocortex/essentials/SecurityHelper" {
import { Site } from "geocortex/essentials/Site";
...
export class SecurityHelper {
    ...
    private _refreshPromiseResolve;
    private _refreshPromiseReject;
    ...
    static waitForSignIn(): Promise<void>;
...
declare module "geocortex/essentials/ServiceHelper" {
/** @docs-hide-from-nav */
...
declare module "geocortex/essentials/ServicePoint" {
import { ICancellationToken, IObservable } from "geocortex/essentials/Rx.light";
/** @docs-hide-from-nav */
export class ServiceRequestError implements Error {
    message: string;
    name: string;
    details: string[];
    toString(): string;
...
/** @docs-hide-from-nav */
export class ServiceRequestAbortedError extends ServiceRequestError {
}
/** @docs-hide-from-nav */
...
declare module "geocortex/essentials/Site" {
import { AsyncInitializable } from "geocortex/essentials/AsyncInitializable";
import { ArcGisPortalSecurityContext } from "geocortex/essentials/ArcGisPortalSecurityContext";
import { DocumentStore } from "geocortex/essentials/documents/DocumentStore";
import { Map } from "geocortex/essentials/Map";
import { Extension } from "geocortex/essentials/Extension";
import { GeocodingEndpoint } from "geocortex/essentials/GeocodingEndpoint";
import { GeometryEndpoint } from "geocortex/essentials/GeometryEndpoint";
import { GeoprocessingEndpoint } from "geocortex/essentials/GeoprocessingEndpoint";
import { NamedExtent } from "geocortex/essentials/NamedExtent";
...
import { LayerCatalog } from "geocortex/essentials/LayerCatalog";
import { Workflow } from "geocortex/essentials/Workflow";
import { SearchTable } from "geocortex/essentials/SearchTable";
import { Principal } from "geocortex/essentials/Principal";
import { FeatureLayerService } from "geocortex/essentials/FeatureLayerService";
import { SearchQuery } from "geocortex/essentials/SearchQuery";
import { SearchResults } from "geocortex/essentials/SearchResults";
import { LayerCatalogParams } from "geocortex/essentials/catalog/LayerCatalogParams";
import { LayerCatalogDetailsParams } from "geocortex/essentials/catalog/LayerCatalogDetailsParams";
import { OfflineBasemap } from "geocortex/essentials/OfflineBasemap";
/**
 ...
 */
export class Site extends AsyncInitializable {
     ...
     */
    getLayerCatalog(catalogParams: LayerCatalogParams, loadBegin: () => void, loadComplete: (results: any) => void, loadError: (e: Error) => void): void;
    /**
     ...
     * @param loadError The callback to run when loading errors.
     */
    getLayerCatalogDetails(catalogParams: LayerCatalogDetailsParams, loadBegin: () => void, loadComplete: (results: any) => void, loadError: (e: Error) => void): void;
    /**
    ...
    /**
     * Refreshes the site's principal. Tries to do a passive sign in in refresh. If that fails,
     * a login prompt may be triggered in a pop-up or new tab.
     */
...
declare module "geocortex/essentials/StreamLayerService" {
import { MapService } from "geocortex/essentials/MapService";
/**
 ...
 */
export class StreamLayerService extends MapService {
    private _streamLayerOptions;
    private _configureStreamSettings(streamSettings);
    /** @private */
    _configureObject(obj: any, deepInitialize?: boolean): void;
    /** @private */
    _createServiceLayer(): void;
...
declare module "geocortex/essentials/TextField" {
/**
...
declare module "geocortex/essentials/TimeExtent" {
/**
...
declare module "geocortex/essentials/TimeInfo" {
import { LayerTimeOptions } from "geocortex/essentials/LayerTimeOptions";
import { TimeExtent } from "geocortex/essentials/TimeExtent";
import { TimeReference } from "geocortex/essentials/TimeReference";
/**
...
export function getGcxTimeInfo(timeInfo: esri.layers.TimeInfo, restStartTimeOverrideString?: string, restEndTimeOverrideString?: string): TimeInfo;

}
declare module "geocortex/essentials/TimeReference" {
/**
...
declare module "geocortex/essentials/TimeSliderMode" {
/**
 * Represents the modes of operation for a {@TimeSliderProfile}
 */
export enum TimeSliderMode {
    Extent = 0,
    Cumulative = 1,
    Instant = 2,
}
...
declare module "geocortex/essentials/TimeSliderProfile" {
import { AsyncInitializable } from "geocortex/essentials/AsyncInitializable";
import { TimeSliderMode } from "geocortex/essentials/TimeSliderMode";
import { TimeExtent } from "geocortex/essentials/TimeExtent";
import { TimeUnits } from "geocortex/essentials/TimeUnits";
import { Extension } from "geocortex/essentials/Extension";
/**
 ...
 */
export class TimeSliderProfile extends AsyncInitializable {
...
declare module "geocortex/essentials/TimeUnits" {
/**
 ...
 */
export class EssentialsTimeUnits {
...
declare module "geocortex/essentials/TokenResult" {
/**
...
declare module "geocortex/essentials/WebMapReference" {
import { AsyncInitializable } from "geocortex/essentials/AsyncInitializable";
import { Site } from "geocortex/essentials/Site";
/**
 * Represents a Web Map, as referenced by a {@link Site}.
 */
export class WebMapReference extends AsyncInitializable {
    ...
    isLoading(): boolean;
    /** @private */ private _getUrlPortions(url);
    /** @private */
     ...
     */
    _initializeWebMap(webMapObject: any, site: Site, loadComplete: (results: any) => void, loadError: (error: Error) => void): void;
    /** @private */
...
declare module "geocortex/essentials/WFSLayerService" {
import { MapService } from "geocortex/essentials/MapService";
/**
 * Representation of a WFS Layer service. The properties in this class represent the configuration served from the Essentials REST API.
 */
export class WFSLayerService extends MapService {
    /**
     * The base url for the WFS service.
     */
    baseUrl: string;
    private _WFSLayerOptions;
    private _defaultMaxFeaturesInOnDemandMode;
    private _defaultMaxFeaturesInSnapshotMode;
    private _defaultWFSLayerMode;
    private _restWFSConfigObject;
    private _configureWFSSettings(restWfsConfigObject?);
    /** @private */
    _configureObject(obj: any, deepInitialize?: boolean): void;
    /** @private */
    _createServiceLayer(): void;
...
declare module "geocortex/essentials/Workflow" {
import { AsyncInitializable } from "geocortex/essentials/AsyncInitializable";
import { Extension } from "geocortex/essentials/Extension";
import { Site } from "geocortex/essentials/Site";
import { ArgumentInfo } from "geocortex/workflow/ArgumentInfo";
/**
 * Represents a GIS workflow reference by a {@link Site}.
 */
export class Workflow extends AsyncInitializable {
     ...
     */
    getOutputsMetadata(): ArgumentInfo[];
    /** @private */
 ...
 */
export function parseObject(node: Node): Object;
export function getAllNodes(node: Node): dojo.NodeList;
export function getNodes(parentTagName: string, childTagName: string, doc: Document): dojo.NodeList;
export function getValue(source: string, document: Document): string;
export function getValue(source: Node, document: Document): string;
export function getAttribute(node: Element, attrName: string): string;

}
declare module "geocortex/forms/DataItem" {
/**
...
declare module "geocortex/forms/FileItem" {
...
declare module "geocortex/forms/FormButton" {
...
declare module "geocortex/forms/FormDefinition" {
import { Observable } from "geocortex/framework/observables";
import { FormItem } from "geocortex/forms/items/FormItem";
import { ValidationResult } from "geocortex/forms/items/validation/ValidationResult";
import { FormItemResult } from "geocortex/forms/items/FormItemResult";
export class FormDefinition {
    ...
    knownTypes: string[];
    /** @private */
    createElementDelegate: (XMLDocument, FormDefinition) => FormItem;
...
declare module "geocortex/forms/getItemType" {
export function getItemType(xmlDoc: Node): string;
 ...
 */
export function _processFormItem(xmlDoc: Element, formDefinition: any): FormItem;

}
declare module "geocortex/optimizer/EventRelay" {
/** @private */
...
declare module "geocortex/workflow/ActivityContext" {
import { ActivityDispatcher } from "geocortex/workflow/ActivityDispatcher";
import { Workflow } from "geocortex/essentials/Workflow";
import { WorkflowState } from "geocortex/workflow/WorkflowState";
import { Site } from "geocortex/essentials/Site";
export class ActivityContext {
     ...
     */
    constructor(dispatcher: ActivityDispatcher, pendingIndex: number, workflow: Workflow, workflowState: WorkflowState);
    /**
...
declare module "geocortex/workflow/ActivityDispatcher" {
...
export interface ActivityDispatcher {
    ...
    workflowComplete(outputs: any, workflow: Workflow): any;
    workflowAbort(context: ActivityContext, workflow: Workflow): void;
}

}
declare module "geocortex/workflow/ArgumentInfo" {
...
declare module "geocortex/workflow/ArgumentValueWrapper" {
export class ArgumentValueWrapper {
    /**
...
import { ActivityContext } from "geocortex/workflow/ActivityContext";
/** @private */
export function handleGetExternalValue(activityContext: ActivityContext): void;
/** @private */
export function handleSetExternalValue(activityContext: ActivityContext): void;

}
declare module "geocortex/workflow/DefaultActivityDispatcher" {
import { ActivityDispatcher } from "geocortex/workflow/ActivityDispatcher";
import { ActivityContext } from "geocortex/workflow/ActivityContext";
import { Workflow } from "geocortex/essentials/Workflow";
export class DefaultActivityDispatcher implements ActivityDispatcher {
    /**
     ...
     */
    constructor();
    constructor(errorHandler: (error: Error, context: ActivityContext) => void, activityBeginHandler: (context: any) => void, activityCompleteHandler: (context: any) => void, workflowCompleteHandler: (outputs: any, workflow: Workflow) => void);
    constructor(errorHandler: (error: Error, context: ActivityContext) => void, activityBeginHandler: (context: any) => void, activityCompleteHandler: (context: any) => void, workflowCompleteHandler: (outputs: any, workflow: Workflow) => void, workflowAbortHandler: (context: any, workflow: Workflow) => void, webRequestBeginHandler: (url: string, workflow: Workflow) => void, webRequestCompleteHandler: (url: string, workflow: Workflow) => void);
    /**
...
import { ActivityContext } from "geocortex/workflow/ActivityContext";
/** @private */
export function getPropertyIgnoreCase(objectWithProperties: any, prop: string): string;
/** @private */
export function handleReport(activityContext: ActivityContext): void;
/** @private */
export function showDebug(activityContext: ActivityContext, isInput: boolean, callback: () => void): void;
/** @private */
export function handleGetBrowserUrl(activityContext: ActivityContext): void;
/** @private */
export function handleExternalDelay(activityContext: ActivityContext): void;
/** @private */
export function handleGetExternalTimeInfo(activityContext: ActivityContext): void;
/** @private */
export function handleWaitForGeoprocessorJobComplete(activityContext: ActivityContext): void;
/** @private */
export function _getJobStatusCode(status: string): number;
/** @private */
export function handleGetLayerInfoByProperty(activityContext: ActivityContext): void;

}
declare module "geocortex/workflow/DialogActivityHandlers" {
import { ActivityContext } from "geocortex/workflow/ActivityContext";
/** @private */
export function handleAlert(activityContext: ActivityContext): void;
/** @private */
export function handleConfirm(activityContext: ActivityContext): void;
/** @private */
export function handlePrompt(activityContext: ActivityContext): void;

}
declare module "geocortex/workflow/ExternalActivityInfo" {
import { ArgumentInfo } from "geocortex/workflow/ArgumentInfo";
export class ExternalActivityInfo {
    /**
...
declare module "geocortex/workflow/LayerActivityHandlers" {
import { ActivityContext } from "geocortex/workflow/ActivityContext";
/** @private */
export function handleSetLayerProperty(activityContext: ActivityContext): void;
/** @private */
export function handleGetLayerProperty(activityContext: ActivityContext): void;
/** @private */
export function handleGetLayerVisibility(activityContext: ActivityContext): void;
/** @private */
export function handleSetLayerVisibility(activityContext: ActivityContext): void;
/** @private */
export function handleGetLayerDefinition(activityContext: ActivityContext): void;
/** @private */
export function handleSetLayerDefinition(activityContext: ActivityContext): void;
/** @private */
export function handleGetGraphicsLayerContent(activityContext: ActivityContext): void;
/**
 * @private
 * OBSOLETE: Use 'handleUpdateGraphicsLayer' method in /modules/workflow/Handlers/HandleUpdateGraphicsLayer.ts as this will ensure correct layer ordering
 * This method is retained for users of the API who do not also have mapping.infrastructure.
 */
export function handleUpdateGraphicsLayer(activityContext: ActivityContext): void;

}
declare module "geocortex/workflow/MapActivityHandlers" {
import { ActivityContext } from "geocortex/workflow/ActivityContext";
export module MapActivityHandlers {
    /** @private */
...
declare module "geocortex/workflow/MapServiceActivityHandlers" {
import { MapService } from "geocortex/essentials/MapService";
import { ActivityContext } from "geocortex/workflow/ActivityContext";
/** @private */
export function findMapServiceById(site: any, serviceId: string): MapService;
/** @private */
export function findMapServiceByMap(map: esri.Map, serviceId: string): esri.layers.Layer;
/** @private */
export function handleRemoveMapService(activityContext: ActivityContext): void;
/** @private */
export function handleSetImageServiceInfo(activityContext: ActivityContext): void;
/** @private */
export function handleSetMapServiceVisibility(activityContext: ActivityContext): void;
/** @private */
export function handleGetMapServiceInfo(activityContext: ActivityContext): void;
/** @private */
export function handleSetMapServiceProperty(activityContext: ActivityContext): void;

}
declare module "geocortex/workflow/NativeActivityHandlers" {
import { ActivityContext } from "geocortex/workflow/ActivityContext";
/** @private */
export function handleGetCurrentPosition(activityContext: ActivityContext): void;
/** @private */
export function handleGetPhoto(activityContext: ActivityContext): void;

}
declare module "geocortex/workflow/SimpleActivityDispatcher" {
import { ActivityDispatcher } from "geocortex/workflow/ActivityDispatcher";
import { ActivityContext } from "geocortex/workflow/ActivityContext";
import { Workflow } from "geocortex/essentials/Workflow";
export class SimpleActivityDispatcher implements ActivityDispatcher {
    /** @private */
     ...
     * @param {Function} [workflowCompleteHandler] The callback function that will be called when the workflow completes.
     */
    constructor(dispatchHandler?: (context: ActivityContext) => void, errorHandler?: (error: Error, activityContext: ActivityContext) => void, activityBeginHandler?: (context: ActivityContext) => void, activityCompleteHandler?: (context: ActivityContext) => void, workflowCompleteHandler?: (outputs: any, workflow: Workflow) => void, workflowAbortHandler?: (context: any, workflow: Workflow) => void, webRequestBeginHandler?: (url: string, workflow: Workflow) => void, webRequestCompleteHandler?: (url: string, workflow: Workflow) => void);
    /**
     * Performs the dispatching of an external activity. This will invoke the dispatchHandler.
     * @param context The context of the activity to dispatch.
     */
...
import { WorkflowState } from "geocortex/workflow/WorkflowState";
import { ActivityContext } from "geocortex/workflow/ActivityContext";
import { ExternalActivityInfo } from "geocortex/workflow/ExternalActivityInfo";
import { ArgumentInfo } from "geocortex/workflow/ArgumentInfo";
export function startWorkflow(workflow: Workflow, dispatcher: ActivityDispatcher, inArgs: any): void;
/** @private */
export function _executeWorkflow(workflow: Workflow, dispatcher: ActivityDispatcher, workflowState: WorkflowState, inArgs: any, activityContext: ActivityContext): void;
/** @private */
export function _processWorkflowResults(results: any, workflow: Workflow, dispatcher: ActivityDispatcher): void;
/** @private */
export function _handleErrorInternal(dispatcher: ActivityDispatcher, error: Error, activityContext?: ActivityContext): void;
/** @private */
export function _preProcessArguments(args: any): void;
/** @private */
export function _getObjectFromJsonWithType(value: any, typeName: string): any;
/** @private */
export function _getExternalActivities(restObject: any): ExternalActivityInfo[];
/** @private */
export function _getArguments(restObject: any): ArgumentInfo[];
/** @private */
export function _dispatch(activityContext: ActivityContext): void;

}
declare module "geocortex/workflow/WorkflowState" {
import { ExternalActivityInfo } from "geocortex/workflow/ExternalActivityInfo";
...
declare module "geocortex/essentials/catalog/CatalogEntry" {
...
declare module "geocortex/essentials/catalog/LayerCatalogDetail" {
import { LayerCatalogDetailEntry } from "geocortex/essentials/catalog/LayerCatalogDetailEntry";
/**
...
export class LayerCatalogDetail {
...
declare module "geocortex/essentials/catalog/LayerCatalogDetailEntry" {
/** An object which contains values to initialize a {@link geocortex.essentials.Layer}.
  ...
  */
export interface LayerCatalogDetailEntry {
    /** The layer's ID. */
    id: string;
...
declare module "geocortex/essentials/catalog/LayerCatalogDetailsParams" {
/** Represents parameters to use when requesting Layer Catalog information from the Essentials REST API. */
export class LayerCatalogDetailsParams {
 ...
 * @private
 */
export function cloneDocument(id: string, document: Document, createOnly: boolean): geocortex.core.documents.BatchRequest;
export function createDocument(document: Document, streamId: string): geocortex.core.documents.BatchRequest;
export function createMoniker(moniker: geocortex.core.documents.Moniker, createOnly: boolean): geocortex.core.documents.BatchRequest;
export function deleteDocument(id: string): geocortex.core.documents.BatchRequest;
export function deleteMoniker(id: string): geocortex.core.documents.BatchRequest;
export function describe(streamId: string): geocortex.core.documents.BatchRequest;
export function generateLinks(count: number): geocortex.core.documents.BatchRequest;
export function modifyDocument(document: Document, streamId: string): geocortex.core.documents.BatchRequest;
export function openDocument(id: string, streamId: string, startPosition: number): geocortex.core.documents.BatchRequest;
export function peekDocument(id: string, throwIfMissing?: boolean): geocortex.core.documents.BatchRequest;
export function peekDocumentAccess(id: string): geocortex.core.documents.BatchRequest;
export function peekMoniker(id: string, throwIfMissing?: boolean): geocortex.core.documents.BatchRequest;
export function peekMonikerAccess(id: string): geocortex.core.documents.BatchRequest;
export function previewDocument(id: string, streamId: string): geocortex.core.documents.BatchRequest;
export function previewMoniker(id: string, streamId: string): geocortex.core.documents.BatchRequest;
export function readDocument(id: string, format: string): geocortex.core.documents.BatchRequest;
export function restoreDocument(globalId: string): geocortex.core.documents.BatchRequest;
export function restoreMoniker(globalId: string): geocortex.core.documents.BatchRequest;
export function resumeDocument(globalId: string, streamId: string): geocortex.core.documents.BatchRequest;
export function scrub(scrubOptions: geocortex.core.documents.ScrubOptions): geocortex.core.documents.BatchRequest;
export function searchDocuments(documentQuery: geocortex.core.documents.Query<Document>): geocortex.core.documents.BatchRequest;
export function searchMonikers(monikerQuery: geocortex.core.documents.Query<geocortex.core.documents.Moniker>): geocortex.core.documents.BatchRequest;
export function searchRoles(searchClause: string): geocortex.core.documents.BatchRequest;
export function searchUsers(searchClause: string): geocortex.core.documents.BatchRequest;
export function self(): geocortex.core.documents.BatchRequest;
export function touchDocument(id: string, modify: boolean, throwIfMissing: boolean): geocortex.core.documents.BatchRequest;
export function updateDocument(document: Document): geocortex.core.documents.BatchRequest;
export function updateMoniker(moniker: geocortex.core.documents.Moniker): geocortex.core.documents.BatchRequest;
export function writeDocument(content: geocortex.core.documents.DocumentContent): geocortex.core.documents.BatchRequest;

}
declare module "geocortex/essentials/documents/Document" {
/**
 ...
 * @private
 */
export interface Document extends geocortex.core.documents.Document {
    /**
...
declare module "geocortex/essentials/documents/DocumentConstants" {
/**
 * String constants that represent the various fields of a {@link Document}.
 * @private
 */
export module DocumentField {
    const AUTHOR_DESCRIPTION = "author.description";
    const AUTHOR_ISSUER_TITLE = "author.issuerTitle";
    const AUTHOR_TITLE = "author.title";
    const DESCRIPTION = "description";
    const EDITOR_DESCRIPTION = "editor.description";
    const EDITOR_ISSUER_TITLE = "editor.issuerTitle";
    const EDITOR_TITLE = "editor.title";
    const FILE_TYPE = "fileType";
    const GRANT_TOKEN = "grants.token";
    const ISSUER_TITLE = "issuerTitle";
    const TAGS = "tags";
    const TIME_CREATION = "timeOfCreation";
    const TIME_LAST_ACCESS = "timeOfLastAccess";
    const TIME_LAST_MODIFICATION = "timeOfLastModification";
    const TITLE = "title";
}
/**
...
export module ContentType {
    const BLOB = "application/octet-stream";
 ...
 * @private
 */
export module GrantKind {
    const FROZEN = "frozen";
    const OWNER = "owner";
    const READER = "reader";
    const WRITER = "writer";
    const READER_LINK = "readerLink";
    const WRITER_LINK = "writerLink";
    const GLOBAL_CREATE = "global_create";
    const GLOBAL_READER = "global_reader";
    const GLOBAL_WRITER = "global_writer";
}
/**
 * String constants that represent the global grant IDs of a {@link Document}.
 * @private
 */
export module GrantID {
 ...
 * @private
 */
export module FilterMethod {
    const RANGES = "ranges";
    const SPATIAL_DISJOINT = "spatialDisjoint";
    const SPATIAL_INTERSECTS = "spatialIntersects";
    const SPATIAL_WITHIN = "spatialWithin";
...
declare module "geocortex/essentials/documents/DocumentStore" {
import { Site } from "geocortex/essentials/Site";
import { Thenable } from "geocortex/essentials/utilities/Thenable";
import { Document } from "geocortex/essentials/documents/Document";
import { QueryParameters, QueryResult } from "geocortex/essentials/documents/Parameters";
export const LINK_QUERY_STRING_KEY = "link";
/**
...
export class DocumentStore {
     ...
     */
    hasPolicyGrant(predicate?: (grant: geocortex.core.documents.Grant, index?: number) => boolean): boolean;
    /**
     * Add a Document to the Document Store.
     * @param doc The Document to add.
     * @return A utilities.Thenable of the Document that was added to the store, after it was processed.
     */
     ...
     * @return A utilities.Thenable of the Document with the given ID.
     */
     ...
     * @return A utilities.Thenable of the Document with its updated values.
     */
     ...
     * @return A utilities.Thenable of the Document that was deleted.
     */
     ...
     * @return A utilities.Thenable of the search result containing the documents.
     */
     ...
     * @return A utilities.Thenable of the batch request response.
     */
    perform(batchRequest: geocortex.core.documents.BatchRequest, usePost?: boolean): Thenable<geocortex.core.documents.BatchRequest>;
    /**
     ...
     */
    protected _processDocument(doc: geocortex.core.documents.Document): Document;
    /**
     ...
     */
    protected static _processReadDocumentResponse(result: geocortex.core.documents.results.ReadDocumentResult, format: string): Document;
    /**
     ...
     */
    protected _processSelf(result: geocortex.core.documents.results.SelfResult): void;
    /**
...
declare module "geocortex/essentials/documents/Parameters" {
/**
 * Query search parameters.
 * @private
 */
export interface QueryParameters extends geocortex.core.documents.Query<Document> {
}
/**
 * Query search results.
 * @private
 */
export interface QueryResult extends geocortex.core.documents.ResultSet<Document> {
}
/**
 * An individual document Query result.
 * @private
 */
export interface Result extends geocortex.core.documents.Result<Document> {
}
...
declare module "geocortex/essentials/exportMap/ExportContext" {
import { ExportOptions } from "geocortex/essentials/exportMap/ExportOptions";
import { ExportLayoutOptions } from "geocortex/essentials/exportMap/ExportLayoutOptions";
import { ExportMapOptions } from "geocortex/essentials/exportMap/ExportMapOptions";
import { ExportMapService } from "geocortex/essentials/exportMap/ExportMapService";
/**
...
declare module "geocortex/essentials/exportMap/ExportDynamicMapLayerDefinition" {
/**
 * Represents the dynamic definition of a layer that has been added to the map.
 * @private
 */
export interface ExportDynamicMapLayerDefinition {
...
declare module "geocortex/essentials/exportMap/ExportFeature" {
import { ExportSymbol } from "geocortex/essentials/exportMap/ExportSymbol";
/**
...
declare module "geocortex/essentials/exportMap/ExportFeatureCollection" {
import { ExportLayer } from "geocortex/essentials/exportMap/ExportLayer";
/**
...
declare module "geocortex/essentials/exportMap/ExportLayer" {
import { ExportMapLayerDefinition } from "geocortex/essentials/exportMap/ExportMapLayerDefinition";
import { ExportLayerFeatureSet } from "geocortex/essentials/exportMap/ExportLayerFeatureSet";
/**
...
declare module "geocortex/essentials/exportMap/ExportLayerFeatureSet" {
import { ExportFeature } from "geocortex/essentials/exportMap/ExportFeature";
/**
 * Represents a set of features to export.
 * @private
 */
export interface ExportLayerFeatureSet {
...
declare module "geocortex/essentials/exportMap/ExportLayoutOptions" {
/**
...
declare module "geocortex/essentials/exportMap/ExportMapLayerDefinition" {
import { ExportDynamicMapLayerDefinition } from "geocortex/essentials/exportMap/ExportDynamicMapLayerDefinition";
/**
 * Represents a layer included in the export map.
 * @private
 */
export interface ExportMapLayerDefinition {
...
declare module "geocortex/essentials/exportMap/ExportMapOptions" {
/**
...
declare module "geocortex/essentials/exportMap/ExportMapParameters" {
import { ReportParameters } from "geocortex/essentials/ReportParameters";
/**
 * Contains parameters to use when exporting maps via {@link ExportMapTask}.
 * @private
 */
export class ExportMapParameters {
    /**
...
declare module "geocortex/essentials/exportMap/ExportMapService" {
import { ExportFeatureCollection } from "geocortex/essentials/exportMap/ExportFeatureCollection";
/**
 * Represents a {@link MapService} bundled for exporting to Essentials for rendering/printing.
 * @private
 */
export interface ExportMapService {
...
declare module "geocortex/essentials/exportMap/ExportMapTask" {
import { Map } from "geocortex/essentials/Map";
import { PrintTemplate } from "geocortex/essentials/PrintTemplate";
import { Report } from "geocortex/essentials/Report";
import { ExportMapParameters } from "geocortex/essentials/exportMap/ExportMapParameters";
/**
...
*/
export var WEBTILED: string;
export var BINGAERIAL: string;
export var BINGAERIALLABELS: string;
export var BINGROADS: string;
export var BINGHYBRID: string;

}
declare module "geocortex/essentials/exportMap/ExportOptions" {
/**
...
declare module "geocortex/essentials/exportMap/ExportSymbol" {
/**
...
declare module "geocortex/essentials/serviceDiscovery/ResultItem" {
/** @private */
/** @private */
export interface ResultItem extends geocortex.essentials.rest.serviceDiscovery.ResultItem {
...
declare module "geocortex/essentials/serviceDiscovery/ServiceDiscoveryProvider" {
...
export interface ServiceDiscoveryProvider {
    ...
    findServices(term: string, options?: FindServicesOptions): Thenable<ResultItem[]>;
    expandService(item: ResultItem): Thenable<ResultItem>;
    realizeMapService(item: ResultItem, sr: string): Thenable<MapService>;
}
/**
...
declare module "geocortex/essentials/serviceDiscovery/serviceDiscoveryServicePoint" {
import { ServicePoint } from "geocortex/essentials/ServicePoint";
import { ResultItem } from "geocortex/essentials/serviceDiscovery/ResultItem";
import { IObservable } from "geocortex/essentials/Rx.light";
import { MapService } from "geocortex/essentials/MapService";
/** @private */
/** @private */
export class ServiceDiscoveryServicePoint {
    service: ServicePoint;
    constructor(service: ServicePoint);
    private postProcess(item);
    findServices(term: string): IObservable<{}>;
    expandService(item: ResultItem): IObservable<ResultItem>;
    expandService(id: string, providerName: string, url: string): IObservable<ResultItem>;
    suggestHints(term: string): IObservable<string>;
    realizeMapService(item: ResultItem, sr: string): IObservable<MapService>;
    realizeMapService(id: string, providerName: string, url: string, sr: string): IObservable<MapService>;
}

}
declare module "geocortex/essentials/serviceDiscovery/SiteServiceDiscoveryProvider" {
import { ServiceDiscoveryProvider, FindServicesOptions } from "geocortex/essentials/serviceDiscovery/ServiceDiscoveryProvider";
import { Site } from "geocortex/essentials/Site";
import { Thenable } from "geocortex/framework/Thenable";
import { ResultItem } from "geocortex/essentials/serviceDiscovery/ResultItem";
import { MapService } from "geocortex/essentials/MapService";
 ...
 */
export class SiteServiceDiscoveryProvider implements ServiceDiscoveryProvider {
    protected _rootUrl: string;
    protected _site: Site;
    supported: boolean;
    initialized: boolean;
     ...
     */
    realizeMapService(item: ResultItem, sr: string): Thenable<MapService>;
    protected sendRequest<T>(url: string, request: any): Thenable<T>;
    ...
    protected _createMapService(item: ResultItem, serviceDefinition: geocortex.essentials.rest.serviceDiscovery.results.RealizeMapServiceResult): Thenable<MapService>;
    /**
...
declare module "geocortex/essentials/utilities/EncodeImageError" {
/**
 * Represents an error resulting from an image encoding operation.
 */
export interface EncodeImageError {
...
declare module "geocortex/essentials/utilities/EncodeImageResult" {
/**
...
declare module "geocortex/essentials/utilities/ExifUtilities" {
export class ExifUtilities {
    static getPointFromExif(exifTags: any): esri.geometry.Point;
    static dmsToDecimal(dms: number[]): number;
    static getExifTagsFromImageBytes(arrayBuffer: ArrayBuffer): any;
    static base64ToArrayBuffer(base64: any, contentType: any): ArrayBuffer;
    static getExifTags(bytes: DataView, start: number, size: number): any;
    static readTags(bytes: DataView, tiffStart: number, dirStart: number, strings: {
        [index: number]: string;
    }, littleEndian: boolean): any;
    static readTagValue(bytes: DataView, entryOffset: number, tiffStart: number, dirStart: number, littleEndian: boolean): any;
    static getStringFromBytes(bytes: DataView, start: number, length: number): string;
    static ExifTags: {
...
declare module "geocortex/essentials/utilities/GraphicsLayerUtilities" {
/**
 * Built in names of components which modules can have their graphics layers be excluded from.
 * Third party modules may pass in additional components as strings.
 */
export const excludeFromExportMapTaskName = "ExportMapTask";
/**
 ...
 * @param excludeFromList The list of activities to exclude, can be found in ExcludeFromEnum
 */
export function getGraphicsLayerIdsToExclude(excludeFromList: string[]): string[];
/**
 * Allows both GVH and 3rd party modules to add their own graphics layer IDs to the list of layers be excluded.
 */
export function addToGraphicsLayerIdsToExclude(excludeFromList: string[], graphicsLayerId: string): void;
/**
 * Allows both GVH and 3rd party modules to remove their own graphics layers IDs to the list of layers be excluded.
 */
export function removeFromGraphicsLayerIdsToExclude(excludeFromList: string[], graphicsLayerId: string): void;

}
declare module "geocortex/essentials/utilities/ImageUtilities" {
/**
 * Conserve aspect ratio of the original image. Useful when shrinking/enlarging
 * images to fit into a certain area.
 *
 * @param srcWidth Source area width
 * @param srcHeight Source area height
 ...
 * @param source Source HTMLImageElement, HTMLCanvasElement, or base64 data uri string of image.
 * @param width Desired width of the image.
 * @param height Desired height of the image.
 * @returns A base64 png image.
 */
export function resizeImage(source: HTMLImageElement | HTMLCanvasElement | string, width: number, height: number): Promise<string>;
/**
 ...
 * @param source Source HTMLImageElement, HTMLCanvasElement, or base64 data uri string of image.
 * @param width Desired maximum width of the image.
 * @param height Desired maximum height of the image.
 * @returns A base64 png image.
 */
export function resizeImageToMaxDimensions(source: HTMLImageElement | HTMLCanvasElement | string, maxWidth: number, maxHeight: number): Promise<string>;
/**
 * Get the raw byte data from a data uri.
 * @param uri The data uri.
 */
export function getRawByteDataFromDataUri(uri: string): string;

}
declare module "geocortex/essentials/utilities/LayerUtilities" {
/** @private */
export class LayerUtilities {
    /** @private */
...
declare module "geocortex/essentials/utilities/PrintUtilities" {
/**
...
declare module "geocortex/essentials/utilities/PromiseUtilities" {
import { Thenable } from "geocortex/essentials/utilities/Thenable";
/**
 ...
 */
export interface SettleInspection<T> {
...
declare module "geocortex/essentials/utilities/ServiceDiscoveryUtilities" {
import { Map } from "geocortex/essentials/Map";
import { MapService } from "geocortex/essentials/MapService";
import { Thenable } from "geocortex/framework/Thenable";
/**
 ...
 */
export class ServiceDiscoveryUtilities {
    /**
     ...
     */
    static buildMapService(essentialsMap: Map, serviceDefinition: any): Thenable<MapService>;
}

}
declare module "geocortex/essentials/utilities/SiteResourceIdComparer" {
/**
 * Utility methods for comparing resource IDs.
 * @private
 */
export class SiteResourceIdComparer {
...
declare module "geocortex/essentials/utilities/StringUtilities" {
export interface LayerStringProperties {
    id: string;
    name: string;
    displayName: string;
    description: string;
}
export interface MapServiceStringProperties {
    id: string;
    url: string;
    displayName: string;
    serviceToken: string;
...
export class StringUtilities {
     ...
     */
    static replaceLayerTokens(match: string, layer: LayerStringProperties): string;
    /**
     ...
     */
    static replaceMapServicetokens(match: string, mapService: MapServiceStringProperties): string;
    /**
...
declare module "geocortex/essentials/utilities/Thenable" {
/**
...
declare module "geocortex/essentials/utilities/UrlUtilities" {
/**
...
declare module "geocortex/forms/items/AutoCompleteBoxFormItem" {
import { TextBoxFormItem } from "geocortex/forms/items/TextBoxFormItem";
import { QueryTaskFormItem, QueryTaskRunner } from "geocortex/forms/items/QueryTaskFormItem";
import { Observable, ObservableCollection } from "geocortex/framework/observables";
import { DataItem } from "geocortex/forms/DataItem";
import { FormDefinitionInterface } from "geocortex/forms/items/FormItem";
export class AutoCompleteBoxFormItem extends TextBoxFormItem implements QueryTaskFormItem {
    /**
     ...
     */
    constructor(xmlNode: Element, formDefinition?: FormDefinitionInterface);
    /**
...
declare module "geocortex/forms/items/CheckBoxFormItem" {
import { AbstractFormItem, FormDefinitionInterface } from "geocortex/forms/items/FormItem";
import { Observable } from "geocortex/framework/observables";
import { FormItemResult } from "geocortex/forms/items/FormItemResult";
export class CheckBoxFormItem extends AbstractFormItem {
    /**
...
declare module "geocortex/forms/items/ComboBoxFormItem" {
import { AbstractFormItem, FormDefinitionInterface } from "geocortex/forms/items/FormItem";
import { LabelContainer } from "geocortex/forms/items/LabelContainer";
import { QueryTaskFormItem, QueryTaskRunner } from "geocortex/forms/items/QueryTaskFormItem";
import { Observable, ObservableCollection } from "geocortex/framework/observables";
import { DataItem } from "geocortex/forms/DataItem";
import { LabelFormItem } from "geocortex/forms/items/LabelFormItem";
import { FormItemResult } from "geocortex/forms/items/FormItemResult";
export class ComboBoxFormItem extends AbstractFormItem implements LabelContainer, QueryTaskFormItem {
    /**
...
declare module "geocortex/forms/items/ContainerFormItem" {
import { AbstractFormItem, FormItem, FormDefinitionInterface } from "geocortex/forms/items/FormItem";
import { ObservableCollection, Observable } from "geocortex/framework/observables";
import { ValidationResult } from "geocortex/forms/items/validation/ValidationResult";
import { FormItemResult } from "geocortex/forms/items/FormItemResult";
export class ContainerFormItem extends AbstractFormItem {
    ...
    /** @private */
    createElementDelegate: (xmlDoc: Element, formDefinition) => FormItem;
    /**
...
declare module "geocortex/forms/items/DataItemsFormItem" {
import { FormItem, FormDefinitionInterface } from "geocortex/forms/items/FormItem";
import { ObservableCollection } from "geocortex/framework/observables";
import { DataItem } from "geocortex/forms/DataItem";
/**
 * <p>Represents a form items that has dataItems.</p>
 */
export interface DataItemsFormItem extends FormItem {
    dataItems: ObservableCollection<DataItem>;
    clearDataItems(): void;
}
export function initDataItemsFormItem(formItem: DataItemsFormItem, xmlNode: Element, formDefinition?: FormDefinitionInterface): void;

}
declare module "geocortex/forms/items/DatePickerFormItem" {
import { AbstractFormItem, FormDefinitionInterface } from "geocortex/forms/items/FormItem";
import { LabelContainer } from "geocortex/forms/items/LabelContainer";
import { LabelFormItem } from "geocortex/forms/items/LabelFormItem";
import { Observable } from "geocortex/framework/observables";
import { TimePickerFormItem } from "geocortex/forms/items/TimePickerFormItem";
import { FormItemResult } from "geocortex/forms/items/FormItemResult";
export class DatePickerFormItem extends AbstractFormItem implements LabelContainer {
    label: LabelFormItem;
    /**
     * The date.
...
declare module "geocortex/forms/items/FilePickerFormItem" {
import { AbstractFormItem, FormDefinitionInterface } from "geocortex/forms/items/FormItem";
import { LabelContainer } from "geocortex/forms/items/LabelContainer";
import { LabelFormItem } from "geocortex/forms/items/LabelFormItem";
import { Observable, ObservableCollection } from "geocortex/framework/observables";
import { FormItemResult } from "geocortex/forms/items/FormItemResult";
export class FilePickerFormItem extends AbstractFormItem implements LabelContainer {
    /**
...
declare module "geocortex/forms/items/FormItem" {
import { FormDefinition } from "geocortex/forms/FormDefinition";
import { ValidationResult } from "geocortex/forms/items/validation/ValidationResult";
import { FormItemResult } from "geocortex/forms/items/FormItemResult";
import { Observable } from "geocortex/framework/observables";
import { ValidationItem } from "geocortex/forms/items/validation/ValidationItem";
/**
 ...
 */
/** @private */
export interface FormDefinitionInterface extends FormDefinition {
}
/** @private */
export interface ValidationResultInterface extends ValidationResult {
}
/** @private */
export interface FormItemResultInterface extends FormItemResult {
}
export interface FormItem {
    ...
    getResult(): FormItemResultInterface;
    refresh(): void;
    validate(): ValidationResultInterface[];
    _render(): Node;
    _destroy(): void;
}
export class AbstractFormItem implements FormItem {
    ...
    /**
     * Gets the result of the form item.
     * @return {{@link geocortex.forms.items.FormItemResultInterface}[]}
     */
    getResult(): FormItemResultInterface;
    /**
    ...
    /**
     * Validates the form item.
     * Returns a collection of items that did not pass validation.
     */
    validate(): ValidationResultInterface[];
    /**
     * @private Renders the form item.
...
declare module "geocortex/forms/items/FormItemResult" {
export class FormItemResult {
    /**
     * The argument name.
     * @type String
     */
...
declare module "geocortex/forms/items/GroupBoxFormItem" {
import { ContainerFormItem } from "geocortex/forms/items/ContainerFormItem";
import { Observable } from "geocortex/framework/observables";
import { FormDefinitionInterface } from "geocortex/forms/items/FormItem";
export class GroupBoxFormItem extends ContainerFormItem {
    /**
...
declare module "geocortex/forms/items/HyperlinkFormItem" {
import { AbstractFormItem, FormDefinitionInterface } from "geocortex/forms/items/FormItem";
import { Observable } from "geocortex/framework/observables";
import { FormItemResult } from "geocortex/forms/items/FormItemResult";
export class HyperlinkFormItem extends AbstractFormItem {
    /**
...
declare module "geocortex/forms/items/ImageFormItem" {
import { AbstractFormItem, FormDefinitionInterface } from "geocortex/forms/items/FormItem";
import { Observable } from "geocortex/framework/observables";
export class ImageFormItem extends AbstractFormItem {
    /**
...
declare module "geocortex/forms/items/LabelContainer" {
import { FormItem, FormDefinitionInterface } from "geocortex/forms/items/FormItem";
import { LabelFormItem } from "geocortex/forms/items/LabelFormItem";
export interface LabelContainer extends FormItem {
    /**
...
export function initLabelContainer(lc: LabelContainer, xmlNode: Element, formDefinition?: FormDefinitionInterface): void;

}
declare module "geocortex/forms/items/LabelFormItem" {
import { AbstractFormItem, FormDefinitionInterface } from "geocortex/forms/items/FormItem";
import { Observable } from "geocortex/framework/observables";
export class LabelFormItem extends AbstractFormItem {
    /**
     * The text that will be displayed by the Label.
     * @type Observable(String)
     */
...
declare module "geocortex/forms/items/ListBoxFormItem" {
import { AbstractFormItem, FormDefinitionInterface } from "geocortex/forms/items/FormItem";
import { LabelContainer } from "geocortex/forms/items/LabelContainer";
import { QueryTaskFormItem, QueryTaskRunner } from "geocortex/forms/items/QueryTaskFormItem";
import { LabelFormItem } from "geocortex/forms/items/LabelFormItem";
...
import { DataItem } from "geocortex/forms/DataItem";
import { FormItemResult } from "geocortex/forms/items/FormItemResult";
export class ListBoxFormItem extends AbstractFormItem implements LabelContainer, QueryTaskFormItem {
    /**
     * The LabelFormItem for this form item.
     * @type Observable(LabelFormItem)
     */
...
declare module "geocortex/forms/items/MarkdownFormItem" {
import { AbstractFormItem, FormDefinitionInterface } from "geocortex/forms/items/FormItem";
import { Observable } from "geocortex/framework/observables";
export class MarkdownFormItem extends AbstractFormItem {
    /**
...
declare module "geocortex/forms/items/QueryTaskFormItem" {
import { DataItemsFormItem } from "geocortex/forms/items/DataItemsFormItem";
import { Observable } from "geocortex/framework/observables";
import { Event as GeocortexEvent } from "geocortex/framework/events/Event";
import { FormDefinitionInterface } from "geocortex/forms/items/FormItem";
export interface QueryTaskFormItem extends DataItemsFormItem {
...
export class QueryTaskRunner {
     ...
     * @param formDefinition The form definition that this form item belongs to.
     */
    constructor(formItem: QueryTaskFormItem, xmlNode: Element, formDefinition?: FormDefinitionInterface);
    /**
     * @private Notifies any listeners that a value has been selected and they should cascade.
     */
...
declare module "geocortex/forms/items/RadioButtonFormItem" {
import { AbstractFormItem, FormDefinitionInterface } from "geocortex/forms/items/FormItem";
import { Observable } from "geocortex/framework/observables";
import { FormItemResult } from "geocortex/forms/items/FormItemResult";
export class RadioButtonFormItem extends AbstractFormItem {
    /**
     * The text associated with the CheckBox.
     * @type Observable(String)
     */
...
declare module "geocortex/forms/items/TextAreaFormItem" {
import { TextBoxFormItem } from "geocortex/forms/items/TextBoxFormItem";
import { Observable } from "geocortex/framework/observables";
import { FormDefinitionInterface } from "geocortex/forms/items/FormItem";
export class TextAreaFormItem extends TextBoxFormItem {
    /**
...
declare module "geocortex/forms/items/TextBoxFormItem" {
import { AbstractFormItem, FormDefinitionInterface } from "geocortex/forms/items/FormItem";
import { LabelContainer } from "geocortex/forms/items/LabelContainer";
import { LabelFormItem } from "geocortex/forms/items/LabelFormItem";
import { Observable } from "geocortex/framework/observables";
import { FormItemResult } from "geocortex/forms/items/FormItemResult";
export class TextBoxFormItem extends AbstractFormItem implements LabelContainer {
    label: LabelFormItem;
    /**
...
declare module "geocortex/forms/items/TimePickerFormItem" {
import { AbstractFormItem, FormDefinitionInterface } from "geocortex/forms/items/FormItem";
import { LabelContainer } from "geocortex/forms/items/LabelContainer";
import { LabelFormItem } from "geocortex/forms/items/LabelFormItem";
import { Observable } from "geocortex/framework/observables";
import { FormItemResult } from "geocortex/forms/items/FormItemResult";
export class TimePickerFormItem extends AbstractFormItem implements LabelContainer {
    label: LabelFormItem;
...
declare module "geocortex/forms/items/validation/FileSizeValidationItem" {
import { ValidationItem } from "geocortex/forms/items/validation/ValidationItem";
import { ValidationResult } from "geocortex/forms/items/validation/ValidationResult";
export class FileSizeValidationItem extends ValidationItem {
    /**
...
declare module "geocortex/forms/items/validation/NumericRangeValidationItem" {
import { ValidationItem } from "geocortex/forms/items/validation/ValidationItem";
import { ValidationResult } from "geocortex/forms/items/validation/ValidationResult";
export class NumericRangeValidationItem extends ValidationItem {
    /**
...
declare module "geocortex/forms/items/validation/RegexValidationItem" {
import { ValidationItem } from "geocortex/forms/items/validation/ValidationItem";
import { ValidationResult } from "geocortex/forms/items/validation/ValidationResult";
export class RegexValidationItem extends ValidationItem {
    /**
...
declare module "geocortex/forms/items/validation/RequiredValidationItem" {
import { ValidationItem } from "geocortex/forms/items/validation/ValidationItem";
import { ValidationResult } from "geocortex/forms/items/validation/ValidationResult";
export class RequiredValidationItem extends ValidationItem {
    /**
...
declare module "geocortex/forms/items/validation/ValidationItem" {
import { ValidationResult } from "geocortex/forms/items/validation/ValidationResult";
...
declare module "geocortex/forms/items/validation/ValidationResult" {
