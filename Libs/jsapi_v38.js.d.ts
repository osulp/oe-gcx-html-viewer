...
declare module esri {
    ...
    export function getProxyRule(url: string): string;
    ...
    export class Graphic {
        ...
        getShape(): dojox.gfx.shape.Shape;
        getShapes(): dojox.gfx.shape.Shape[];
        getTitle(): string;
        hide(): void;
    ...
    export class Map {
        ...
        hidePanArrows(): void;
        hideZoomSlider(): void;
        on(event: string, handler: (event: { target: any; }) => void ): dojo.RemovableHandle;
        on(event: "basemap-change", handler: (event: { target: esri.Map; }) => void): dojo.RemovableHandle;
        on(event: "click", handler: (event: MouseEvent) => void): dojo.RemovableHandle;
        on(event: "dbl-click", handler: (event: MouseEvent) => void): dojo.RemovableHandle;
        on(event: "extent-change", handler: (event: { target: esri.Map; extent: esri.geometry.Extent; delta: esri.geometry.Point; levelChange: boolean; lod: esri.layers.LOD; }) => void): dojo.RemovableHandle;
        on(event: "key-down", handler: (event: KeyboardEvent) => void): dojo.RemovableHandle;
        on(event: "key-up", handler: (event: KeyboardEvent) => void): dojo.RemovableHandle;
        on(event: "layer-add", handler: (event: { target: esri.Map; layer: esri.layers.Layer; }) => void): dojo.RemovableHandle;
        on(event: "layer-add-result", handler: (event: { target: esri.Map; layer: esri.layers.Layer; error: Error; }) => void): dojo.RemovableHandle;
        on(event: "layer-remove", handler: (event: { target: esri.Map; layer: esri.layers.Layer; }) => void): dojo.RemovableHandle;
        on(event: "layer-reorder", handler: (event: { target: esri.Map; layer: esri.layers.Layer; index: number; }) => void): dojo.RemovableHandle;
        on(event: "layer-resume", handler: (event: { target: esri.Map; layer: esri.layers.Layer; }) => void): dojo.RemovableHandle;
        on(event: "layers-add-result", handler: (event: { target: esri.Map; }) => void): dojo.RemovableHandle;
        on(event: "layers-removed", handler: (event: { target: esri.Map; }) => void): dojo.RemovableHandle;
        on(event: "layers-reordered", handler: (event: { target: esri.Map; layerIds: number[]; }) => void): dojo.RemovableHandle;
        on(event: "load", handler: (event: { target: esri.Map; map: esri.Map; }) => void): dojo.RemovableHandle;
        on(event: "mouse-down", handler: (event: MouseEvent) => void): dojo.RemovableHandle;
        on(event: "mouse-drag", handler: (event: MouseEvent) => void): dojo.RemovableHandle;
        on(event: "mouse-drag-end", handler: (event: MouseEvent) => void): dojo.RemovableHandle;
        on(event: "mouse-drag-start", handler: (event: MouseEvent) => void): dojo.RemovableHandle;
        on(event: "mouse-move", handler: (event: MouseEvent) => void): dojo.RemovableHandle;
        on(event: "mouse-out", handler: (event: MouseEvent) => void): dojo.RemovableHandle;
        on(event: "mouse-over", handler: (event: MouseEvent) => void): dojo.RemovableHandle;
        on(event: "mouse-up", handler: (event: MouseEvent) => void): dojo.RemovableHandle;
        on(event: "mouse-wheel", handler: (event: MouseEvent) => void): dojo.RemovableHandle;
        on(event: "pan", handler: (event: { target: esri.Map; extent: esri.geometry.Extent; delta: esri.geometry.Point; }) => void): dojo.RemovableHandle;
        on(event: "pan-end", handler: (event: { target: esri.Map; extent: esri.geometry.Extent; delta: esri.geometry.Point; }) => void): dojo.RemovableHandle;
        on(event: "pan-start", handler: (event: { target: esri.Map; extent: esri.geometry.Extent; }) => void): dojo.RemovableHandle;
        on(event: "reposition", handler: (event: { target: esri.Map; x: number; y: number; }) => void): dojo.RemovableHandle;
        on(event: "resize", handler: (event: { target: esri.Map; extent: esri.geometry.Extent; width: number; height: number; }) => void): dojo.RemovableHandle;
        on(event: "time-extent-change", handler: (event: { target: esri.Map; timeExtent: esri.TimeExtent; }) => void): dojo.RemovableHandle;
        on(event: "unload", handler: (event: { target: esri.Map; map: esri.Map; }) => void): dojo.RemovableHandle;
        on(event: "update-end", handler: (event: { target: esri.Map; error: Error; }) => void): dojo.RemovableHandle;
        on(event: "update-start", handler: (event: { target: esri.Map; }) => void): dojo.RemovableHandle;
        on(event: "zoom", handler: (event: { target: esri.Map; extent: esri.geometry.Extent; zoomFactor: number; anchor: esri.geometry.Point; }) => void): dojo.RemovableHandle;
        on(event: "zoom-end", handler: (event: { target: esri.Map; extent: esri.geometry.Extent; zoomFactor: number; anchor: esri.geometry.Point; level: number; }) => void): dojo.RemovableHandle;
        on(event: "zoom-start", handler: (event: { target: esri.Map; extent: esri.geometry.Extent; zoomFactor: number; anchor: esri.geometry.Point; level: number; }) => void): dojo.RemovableHandle;
...
declare module esri.dijit {
    ...
    export class Geocoder {
        ...
        value: string;
        zoomScale: number;
        constructor(params: GeocoderOptions, srcNodeRef: any);
        blur(): void;
        clear(): void;
        destroy(): void;
        find(): dojo.Deferred;
...
declare module esri.dijit.analysis {
    export class AggregatePoints extends AnalysisBase<AggregatePoints> {
    ...
    export class AnalysisBase<T extends AnalysisBase<any>> {
        toolServiceUrl: string;
        cancel(jobInfo: any): void;
        execute(params: any): void;
        getCreditsEstimate(toolName: string, jobParams: string): dojo.Deferred;
        on(event: string, handler: (event: { target: T; }) => void ): void;
        on(event: "close", handler: (event: { target: T; }) => void ): void;
        on(event: "drawtool-activate", handler: (event: { target: T; }) => void ): void;
        on(event: "drawtool-deactivate", handler: (event: { target: T; }) => void ): void;
        on(event: "job-cancel", handler: (event: { target: T; response: any; }) => void ): void;
        on(event: "job-fail", handler: (event: { target: T; error: any; }) => void ): void;
        on(event: "job-result", handler: (event: { target: T; result: any; }) => void ): void;
        on(event: "job-status", handler: (event: { target: T; jobInfo: any; }) => void ): void;
        on(event: "job-submit", handler: (event: { target: T; params: any; }) => void ): void;
        on(event: "job-success", handler: (event: { target: T; jobInfo: any; }) => void ): void;
        on(event: "start", handler: (event: { target: T; params: any; }) => void ): void;
    }
    export class CreateBuffers extends AnalysisBase<CreateBuffers> {
        analysisGpServer: string;
    ...
    export class CreateDriveTimeAreas extends AnalysisBase<CreateDriveTimeAreas> {
        analysisGpServer: string;
        breakUnits: string;
        breakValues: number[];
        inputLayer: esri.layers.FeatureLayer;
    ...
    export class DissolveBoundaries extends AnalysisBase<DissolveBoundaries> {
        analysisGpServer: string;
    ...
    export class EnrichLayer extends AnalysisBase<FindHotSpots> {
        analysisGpServer: string;
        distance: number;
        inputLayer: esri.layers.FeatureLayer;
        map: esri.Map;
    ...
    export class ExtractData extends AnalysisBase<FindHotSpots> {
        analysisGpServer: string;
        clip: boolean;
        dataFormat: string;
    ...
    export class FindHotSpots extends AnalysisBase<FindHotSpots> {
    ...
    export class FindNearest extends AnalysisBase<FindHotSpots> {
        analysisGpServer: string;
        analysisLayer: esri.layers.FeatureLayer;
        map: esri.Map;
        maxCount: number;
    ...
    export class MergeLayers extends AnalysisBase<FindHotSpots> {
        analysisGpServer: string;
        inputLayer: esri.layers.FeatureLayer;
        map: esri.Map;
    ...
    export class OverlayLayers extends AnalysisBase<FindHotSpots> {
        analysisGpServer: string;
        inputLayer: esri.layers.FeatureLayer;
        map: esri.Map;
        outputLayerName: string;
    ...
    export class SummarizeNearby extends AnalysisBase<FindHotSpots> {
        analysisGpServer: string;
        distance: number[];
        groupByField: string;
        map: esri.Map;
    ...
    export class SummarizeWithin extends AnalysisBase<FindHotSpots> {
        analysisGpServer: string;
        groupByField: string;
        map: esri.Map;
        outputLayerName: string;
...
declare module esri.dijit.geoenrichment {
    ...
    export module InfographicsOptions {
        export class Item {
            datasetID: string;
            isVisible: boolean;
            title: string;
...
declare module esri.geometry {
    ...
    export class Circle extends Geometry {
        ...
        rings: number[][];
        spatialReference: esri.SpatialReference;
        constructor(center: number[], options?: CircleOptions);
        constructor(center: esri.geometry.Point, options?: CircleOptions);
...
declare module esri.tasks.geoenrichment {
    ...
    export class StandardGeographyStudyArea {
        attributes: string;
        comparisonGeographyLevels: GeographyLevel[];
        countryID: string;
