...
import { TypedBehavior } from "geocortex/framework/behaviors/TypedBehavior";
...
export const _nonConfigs: string[];

}
declare module "geocortex/framework/dependencies" {

}
declare module "geocortex/framework/events" {
import { TypedEvent } from "geocortex/framework/events/TypedEvent";
import { RegionAdapterBase, RegionViewHostingEventArgs } from "geocortex/framework/ui/RegionAdapterBase";
import { ViewBase } from "geocortex/framework/ui/ViewBase";
import { ViewDimensionsChangedArgs } from "geocortex/framework/events/ViewDimensionsChangedArgs";
...
export interface FrameworkEvents extends EventsBase {
    ...
    (eventName: "ViewHostedEvent"): TypedEvent<{
        (args: RegionViewHostingEventArgs): void;
    }>;
    /**
    ...
    * @docs-gcx-event geocortex.framework
    * @name NetworkConnectivityChangedEvent
    * @param isNetworkConnectionAvailable The value indicating if the internet connection is available.
    * @introduced 2.9.1
    * @gcx-event-category Network
    */
    (eventName: "NetworkConnectivityChangedEvent"): TypedEvent<{
        (isNetworkConnectionAvailable: boolean): void;
    }>;
}

}
declare module "geocortex/framework/FrameworkObject" {
import { Application } from "geocortex/framework/application/Application";
/**
...
declare module "geocortex/framework/index" {
import { Application } from "geocortex/framework/application/Application";
...
export function registerApplication(application: Application): void;
export function hasLibrary(libraryId: any): boolean;
export function notifyLibraryDownload(libraryId: string): void;
export function initialize(): void;

}
declare module "geocortex/framework/observables" {
import { Event as GeocortexEvent } from "geocortex/framework/events/Event";
import { ThrottledOperation } from "geocortex/framework/utils/ThrottledOperation";
...
export class ObservableCollection<T> {
    ...
    * @param newCollection The raw collection to copy. */
     ...
     */
    bind(scope: any, handler: (args: CollectionChangedArgs) => void): string;
    /**
...
declare module "geocortex/framework/resourceManager" {
import { ResourceManager } from "geocortex/framework/application/ResourceManager";
export var resourceManager: ResourceManager;

}
declare module "geocortex/framework/SimplePromise" {
 ...
 */
export class SimplePromise<T> implements Thenable<T> {
...
declare module "geocortex/framework/Thenable" {
/**
...
export interface Deferrable<T> extends Thenable<T> {
...
declare module "geocortex/framework/application/Application" {
import { FrameworkCommands } from "geocortex/framework/commands";
import { FrameworkEvents } from "geocortex/framework/events";
import { BehaviorBase } from "geocortex/framework/Behaviors";
import { ApplicationJson, ConfigurationModel } from "geocortex/framework/config/ConfigurationModel";
import { Observable } from "geocortex/framework/observables";
import { Trace } from "geocortex/framework/utils/Trace";
import { ModuleManager } from "geocortex/framework/application/ModuleManager";
import { CommandRegistry } from "geocortex/framework/commands/CommandRegistry";
import { EventRegistry } from "geocortex/framework/events/EventRegistry";
import { BehaviorRegistry } from "geocortex/framework/behaviors/BehaviorRegistry";
import { Store } from "geocortex/framework/storage/Store";
import { ViewManager } from "geocortex/framework/ui/ViewManager";
import { PopupModalRegionAdapter } from "geocortex/framework/ui/PopupModalRegionAdapter";
...
export class Application {
     ...
     * in the case that an OAuth style authentication redirect is needed, or an erroneous condition will prevent the app and initialization
    ...
    /**
     * Indicates whether or not the application is functioning in some sort of enhanced native container, e.g. within some
     * native application container or framework.
     */
    ...
    */
    ...
    private _allViewModels;
    private _requireErrorHandlerHandle;
    /**
    ...
    private _handleRequireError(error);
    /**
     ...
     */
    onLibrariesDownloaded(app: Application): void;
    /**
    ...
    /** Book-keeping for module loading/initialization. Stores all module subcomponent exports, like view model classes and view markup. */
    private _moduleRecords;
    /** View model instances by ID. */
    private _viewModelEntries;
    /**
     * Get the library configuration with the given ID.
     * @param libraryId
     * @private
     */
    private _getLibraryConfig(libraryId);
    /**
    * Return the path to an async module's root directory (no trailing slash).
    * @param moduleConfig Configuration for a single module.
    * @private
    */
    private _getAsyncModuleRoot(moduleConfig);
    /**
     * Initialize records for every module.
     * @private
     */
    private _establishRecords();
    /**
     * Start downloading all configured modules, async and traditional.
     * @private
     */
    private _download();
    /**
     * Start downloading all traditional (async=false) libraries.
     * @private
     */
    private _loadTraditionalLibraries();
    /**
     * Load async libraries cache bundles and register dojo path if specified.
     * @private
     */
    private _cacheAsyncLibrariesAndRegisterPath();
    /**
     * Load async module cache bundles.
     * @private
     */
    private _cacheAsyncModules();
    /**
     * Start loading (simultaneously) all async modules and their subcomponents, saving all of their AMD exports to the module records for later access (to instance and initialize them).
     * For each async library which completes, notifyLibraryDownload will be called.
     * @private
     */
    private _loadAsyncLibraries();
    /**
     * Instance and initialize all of the modules which belong to the library with the provided ID.
     * @param libraryId
     * @private
     */
    private _initializeLibrary(libraryId, errback?);
    /**
     * Initialize an async module based on the provided module record.
     * @param moduleRecord
     * @private
     */
    private _initializeModule(moduleRecord, errback?);
    /**
     * Instance and initialize traditional modules.
     * @param modules
     * @private
     */
    private _initializeTraditionalModules(modules);
    /**
...
declare module "geocortex/framework/application/ApplicationCommands" {
import { Application } from "geocortex/framework/application/Application";
...
declare module "geocortex/framework/application/ModuleBase" {
import { FrameworkObject } from "geocortex/framework/FrameworkObject";
import { Application } from "geocortex/framework/application/Application";
import { Thenable } from "geocortex/framework/Thenable";
...
declare module "geocortex/framework/application/ModuleManager" {
import { Application } from "geocortex/framework/application/Application";
...
declare module "geocortex/framework/application/ResourceManager" {
...
declare module "geocortex/framework/behaviors/Behavior" {
import { TypedBehavior } from "geocortex/framework/behaviors/TypedBehavior";
import { Application } from "geocortex/framework/application/Application";
export class Behavior implements TypedBehavior<any> {
    /**
     ...
     */
    constructor(app: Application, name: string, commands: string[], event?: string);
    /**
...
declare module "geocortex/framework/behaviors/BehaviorRegistry" {
import { Application } from "geocortex/framework/application/Application";
import { Behavior } from "geocortex/framework/behaviors/Behavior";
import { FrameworkObject } from "geocortex/framework/FrameworkObject";
...
declare module "geocortex/framework/behaviors/Behaviors" {
import { TypedBehavior } from "geocortex/framework/behaviors/TypedBehavior";
export interface BehaviorBase {
    (behaviorName: string): TypedBehavior<any>;
}
...
declare module "geocortex/framework/behaviors/TypedBehavior" {
/**
 ...
 */
export interface TypedBehavior<T extends Function> {
    name: string;
    commands: string[];
    event: string;
    eventToken: string;
...
declare module "geocortex/framework/commands/Command" {
import { TypedCommand } from "geocortex/framework/commands/TypedCommand";
import { Application } from "geocortex/framework/application/Application";
import { Event as GeocortexEvent } from "geocortex/framework/events/Event";
/**
 ...
 * @docs-hide-from-nav
 */
export interface FunctionReturning<T> extends Function {
 ...
 */
export class Command implements TypedCommand<any> {
    private _entries;
     ...
     * A `canExecuteMode` of *any* will prevent the command from running if any of the constituent implementations return false in their `canExecute` delegate.
     * A `canExecuteMode` of *all* (the default) will only prevent the command from running if all of the constituent `canExecute` delegates return false.
     */
    constructor(name: string, app: Application, canExecuteMode?: string);
    /**
...
declare module "geocortex/framework/commands/CommandRegistry" {
import { Application } from "geocortex/framework/application/Application";
...
declare module "geocortex/framework/commands/TypedCommand" {
import { Event as GeocortexEvent } from "geocortex/framework/events/Event";
import { TypedEvent } from "geocortex/framework/events/TypedEvent";
import { FunctionReturning } from "geocortex/framework/commands/Command";
/**
 ...
 */
export interface TypedCommand<T extends Function> {
    name: string;
    isWrapper: boolean;
    canExecuteMode: string;
    canExecuteChanged: GeocortexEvent;
...
declare module "geocortex/framework/events/CollectionChangedArgs" {
...
declare module "geocortex/framework/events/Event" {
import { TypedEvent } from "geocortex/framework/events/TypedEvent";
import { Application } from "geocortex/framework/application/Application";
/**
 ...
 */
export class Event implements TypedEvent<any> {
...
declare module "geocortex/framework/events/EventRegistry" {
import { Event as GeocortexEvent } from "geocortex/framework/events/Event";
import { Application } from "geocortex/framework/application/Application";
/**
...
declare module "geocortex/framework/events/TypedEvent" {
/**
 * Defines the typed signature for an event. This type is distinct from Event itself as it is a backwards compatible
 * decorator whose job is to create and enforce type signatures using the newer, shortened event syntax.
 */
export interface TypedEvent<T extends Function> {
    name: string;
    isPublishing: boolean;
    getSubscriptionHandlerByToken(token: string): Function;
    publish: T;
...
declare module "geocortex/framework/events/ViewDimensionsChangedArgs" {
import { ViewBase } from "geocortex/framework/ui/ViewBase";
export class ViewDimensionsChangedArgs {
    view: ViewBase;
    region: any;
    constructor(view: ViewBase, region: any);
}

}
declare module "geocortex/framework/config/ConfigurationLoader" {
import { Application } from "geocortex/framework/application/Application";
...
export function checkList(url: string): boolean;

}
declare module "geocortex/framework/config/ConfigurationModel" {
import { LibraryConfigLocale, LibraryConfig } from "geocortex/framework/config/LibraryConfig";
import { Application } from "geocortex/framework/application/Application";
import { ModuleConfig } from "geocortex/framework/config/ModuleConfig";
import { WidgetConfig } from "geocortex/framework/config/WidgetConfig";
...
export interface ViewModelJson {
    id: string;
    type: string;
    libraryId?: string;
    configuration: any;
...
declare module "geocortex/framework/config/LibraryConfig" {
export interface LibraryConfigLocale {
    locale: string;
    uri: string;
    libraryId?: string;
}
...
declare module "geocortex/framework/config/ModuleConfig" {
import { ViewConfig } from "geocortex/framework/config/ViewConfig";
import { ViewModelConfig } from "geocortex/framework/config/ViewModelConfig";
/**
...
declare module "geocortex/framework/config/ViewConfig" {
...
declare module "geocortex/framework/config/ViewModelConfig" {
/**
 * Holds configuration information about a view model
 */
export class ViewModelConfig {
    /**
...
declare module "geocortex/framework/config/WidgetConfig" {
/**
...
declare module "geocortex/framework/storage/FileStorageProvider" {
import { StorageProviderBase } from "geocortex/framework/storage/StorageProviderBase";
import { StorageStats } from "geocortex/framework/storage/StorageStats";
/**
* GVH-4200: Chrome 54 removed support for FileError objects.  All relevant errors will not be either DOMError or DOMException objects.
* Both DOMError and DOMException objects have common name properties.  Let's replace all instances of FileError code properties with this name property.
* See https://developers.google.com/web/updates/2016/08/chrome-53-deprecations.
*
* String constants that represent the various types of {@link DOMError} and {@link DOMException}.
*/
export module ErrorType {
    const QUOTA_EXCEEDED_ERR: string;
    const NOT_FOUND_ERR: string;
    const SECURITY_ERR: string;
    const INVALID_MODIFICATION_ERR: string;
    const INVALID_STATE_ERR: string;
}
export class FileStorageProvider extends StorageProviderBase {
...
declare module "geocortex/framework/storage/HttpStorageProvider" {
import { StorageProviderBase } from "geocortex/framework/storage/StorageProviderBase";
import { Application } from "geocortex/framework/application/Application";
export class HttpStorageProvider extends StorageProviderBase {
...
declare module "geocortex/framework/storage/LocalStorageProvider" {
import { StorageProviderBase } from "geocortex/framework/storage/StorageProviderBase";
import { StorageStats } from "geocortex/framework/storage/StorageStats";
/**
 * Storage provider that uses the widely supported Local Storage mechanism to persist values.
 */
export class LocalStorageProvider extends StorageProviderBase {
...
declare module "geocortex/framework/storage/StorageProviderBase" {
import { Application } from "geocortex/framework/application/Application";
import { StorageStats } from "geocortex/framework/storage/StorageStats";
...
declare module "geocortex/framework/storage/StorageStats" {
...
declare module "geocortex/framework/storage/Store" {
import { Application } from "geocortex/framework/application/Application";
import { StorageProviderBase } from "geocortex/framework/storage/StorageProviderBase";
/**
...
export class Store {
     ...
     */
    constructor(app: Application, keyNamespace?: string);
    /**
     ...
     */
    initialize(provider?: StorageProviderBase): void;
    hasProvider(): boolean;
    private _yield(func);
...
declare module "geocortex/framework/ui/BindingEngine" {
import { ViewBase } from "geocortex/framework/ui/ViewBase";
export interface BindingEngine {
    bind(markupRoot: HTMLElement, view: ViewBase, context: any): any;
    unbind(view: ViewBase): any;
}
export class DefaultBindingEngine implements BindingEngine {
    private expressionFactories;
    bind(markupRoot: HTMLElement, view: ViewBase, context: any): void;
    unbind(view: ViewBase): void;
}

}
declare module "geocortex/framework/ui/BindingExpression" {
import { Event as GeocortexEvent } from "geocortex/framework/events/Event";
import { ViewBase } from "geocortex/framework/ui/ViewBase";
/**
...
declare module "geocortex/framework/ui/BindingExpressionFactory" {
/** @private */
export class BindingExpressionFactory {
}

}
declare module "geocortex/framework/ui/BindingExpressionHandler" {
/** @private */
export interface BindingExpressionHandler {
    expression: string;
}

}
declare module "geocortex/framework/ui/BindingInterfaces" {
/** @private */
export interface BindingEventHandler {
    (event: Event, element: HTMLElement, context: any): any;
}

}
declare module "geocortex/framework/ui/BindingNode" {
...
declare module "geocortex/framework/ui/DisposableBinding" {
import { Event as GeocortexEvent } from "geocortex/framework/events/Event";
/**
...
declare module "geocortex/framework/ui/DivRegionAdapter" {
 ...
 */
export class DivRegionAdapter extends RegionAdapterBase {
    /**
...
declare module "geocortex/framework/ui/DivStackRegionAdapter" {
import { RegionAdapterBase } from "geocortex/framework/ui/RegionAdapterBase";
import { ViewBase } from "geocortex/framework/ui/ViewBase";
import { Application } from "geocortex/framework/application/Application";
/**
 ...
 */
export class DivStackRegionAdapter extends RegionAdapterBase {
...
declare module "geocortex/framework/ui/MultiDivRegionAdapter" {
import { MultiViewRegionAdapter } from "geocortex/framework/ui/MultiViewRegionAdapter";
export class MultiDivRegionAdapter extends MultiViewRegionAdapter {
    getHostedTagName(): string;
}

}
declare module "geocortex/framework/ui/MultiViewRegionAdapter" {
import { RegionAdapterBase } from "geocortex/framework/ui/RegionAdapterBase";
import { ViewBase } from "geocortex/framework/ui/ViewBase";
export class MultiViewRegionAdapter extends RegionAdapterBase {
    /**
...
declare module "geocortex/framework/ui/PopupModalRegionAdapter" {
import { RegionAdapterBase } from "geocortex/framework/ui/RegionAdapterBase";
import { ViewBase } from "geocortex/framework/ui/ViewBase";
import { Application } from "geocortex/framework/application/Application";
/**
 ...
 * popup is dismissed.
 */
export class PopupModalRegionAdapter extends RegionAdapterBase {
    ...
    private _canExecuteCloseModalRegion();
}

}
declare module "geocortex/framework/ui/RegionAdapterBase" {
import { ViewBase } from "geocortex/framework/ui/ViewBase";
import { Application } from "geocortex/framework/application/Application";
/**
 * Describes the format of event arguments related to views being hosted or unhosted in a particular region.
 */
export interface RegionViewHostingEventArgs {
    view: ViewBase;
 ...
 */
export class RegionAdapterBase {
...
declare module "geocortex/framework/ui/ViewBase" {
import { FrameworkObject } from "geocortex/framework/FrameworkObject";
import { Observable } from "geocortex/framework/observables";
import { BindingNode } from "geocortex/framework/ui/BindingNode";
import { RegionAdapterBase } from "geocortex/framework/ui/RegionAdapterBase";
import { DisposableBinding } from "geocortex/framework/ui/DisposableBinding";
import { Application } from "geocortex/framework/application/Application";
import { BindingExpression } from "geocortex/framework/ui/BindingExpression";
/**
 ...
 */
export class ViewBase extends FrameworkObject {
...
declare module "geocortex/framework/ui/ViewManager" {
import { ViewBase } from "geocortex/framework/ui/ViewBase";
import { Application } from "geocortex/framework/application/Application";
import { RegionAdapterBase } from "geocortex/framework/ui/RegionAdapterBase";
import { ViewConfigInterface } from "geocortex/framework/config/ViewConfig";
export class ViewManagerRegionEntry {
    name: String;
    views: ViewBase[];
}
export class ViewManager {
     ...
     * @param viewInstance View instance is already provided under async library mode.
     */
    createView(viewConfig: ViewConfigInterface, viewInstance?: ViewBase): ViewBase;
    /**
...
declare module "geocortex/framework/ui/ViewModelBase" {
import { FrameworkObject } from "geocortex/framework/FrameworkObject";
import { Application } from "geocortex/framework/application/Application";
export class ViewModelBase extends FrameworkObject {
    constructor(app: Application, libraryId?: string);
...
import { Grouping } from "geocortex/framework/utils/Grouping";
/**
 * Returns the first element in a sequence that satisfies a specified condition.
 * @param source The sequence of values to return an element from.
 * @param predicate A function to test each element for a condition.
 */
export function firstOrDefault<TSource>(source: TSource[], predicate?: (element: TSource, index?: number) => boolean): TSource;
/**
 * Returns the last element in a sequence that satisfies a specified condition.
 * @param source The sequence of values to return an element from.
 * @param predicate A function to test each element for a condition.
 */
export function lastOrDefault<TSource>(source: TSource[], predicate?: (element: TSource, index?: number) => boolean): TSource;
/**
 ...
 */
export function orderBy<TSource, TKey>(source: TSource[], keySelector: (element: TSource) => TKey): TSource[];
/**
 ...
 * @param keySelector A function to extract the key for each element.
 */
export function orderByDescending<TSource, TKey>(source: TSource[], keySelector: (element: TSource) => TKey): TSource[];
/**
 ...
 * @param keySelector A function to extract the key for each element.
 */
export function groupBy<TSource, TKey>(source: TSource[], keySelector: (element: TSource) => TKey): Grouping<TKey, TSource>[];
/**
 * Returns distinct elements from a sequence by using the default equality comparer to compare values.
 * The source sequence remains unaltered.
 * @param source The sequence to remove duplicate elements from.
 */
export function distinct<TSource>(source: TSource[]): TSource[];
/**
 ...
 */
export function remove(array: any[], from: number, to?: number): any[];
/**
 ...
 */
export function removeItem(array: any[], obj: any): any[];
/**
 * Checks whether or not an array contains a specific object.
 * @param array The array to check.
 * @param obj The object to check for.
 */
export function contains(array: any[], obj: any): boolean;
/**
 * Returns the index of a given object, if it exists in an array.
 * @param array The Array to check.
 * @param obj The object to check for.
 */
export function pos(array: any[], obj: any): number;
/**
...
declare module "geocortex/framework/utils/DateFormatters" {
/**
...
export function containsTimezone(s: string): boolean;
export function getTimezoneOffset(): number;
export function getTimezoneString(): string;

}
declare module "geocortex/framework/utils/Grouping" {
/**
...
declare module "geocortex/framework/utils/String" {
/** @private */
...
declare module "geocortex/framework/utils/ThrottledOperation" {
/**
 * Models an operation that executes periodically based on a specific interval.
 * @private
 */
export class ThrottledOperation {
...
declare module "geocortex/framework/utils/Trace" {
import { Application } from "geocortex/framework/application/Application";
/**
...
export class Trace {
    ...
    app: Application;
    /** The name of this application, for source identification */
    private _appName;
    /**
...
declare module "geocortex/framework/utils/Tuple" {
export class Tuple {
    item1: any;
    item2: any;
    item3: any;
...
declare module "geocortex/framework/utils/utils" {
export var base64keyStr: string;
 ...
 */
export function makeUrlAbsolute(url: string): string;
/**
 ...
 */
export function utf8Encode(s: string): string;
/**
 ...
 */
export function addEventListener(obj: any, type: any, listener: any): void;
