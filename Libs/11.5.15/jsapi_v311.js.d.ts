...
declare module esri {
  ...
  export class Color extends dojo.Color {
...
declare module esri.dijit {
  ...
  export class Measurement {
    ...
    on(type: "measure-end", listener: (event: { geometry: Geometry; toolName: string; unitName: string; values: any; target: Measurement }) => void): esri.Handle;
...
declare module esri.geometry {
  ...
  export class Multipoint extends Geometry {
     ...
     * @param point Point to add to the Multipoint.
     */
     ...
     */
    addPoint(coords: number[]): Multipoint;
    /** 
     * Adds a point to the Multipoint. The point can be one of the following: an Esri Point, a number array, or a JSON object. 
     * @param json JSON object representing the geometry.
     */
    addPoint(json: Object): Multipoint;
...
declare module esri.tasks {
  ...
  export class FeatureSet {
    ...
    /** Legacy. Returns an easily serializable object representation of the FeatureSet. */
    toJson(): any;
  }
...
declare module esri.toolbars {
  ...
  export class Edit {
     ...
     * @param options See the object specifications table below for the structure of the  options  object.
     */
    activate(tool: number, graphic: Graphic, options?: any): void;
    /** Deactivates the toolbar. */
    deactivate(): void;
    /** An object with the following properties that describe the current state. */
    getCurrentState(): { tool: number; graphic: Graphic; isModified: boolean };
    /** Refreshes the internal state of the toolbar. */
    refresh(): void;
    /** Activates the toolbar for editing geometries. */
    on(type: "activate", listener: (event: { graphic: Graphic; tool: number; target: Edit }) => void): esri.Handle;
    /** Deactivates the toolbar and reactivates map navigation. */
    on(type: "deactivate", listener: (event: { graphic: Graphic; info: any; tool: number; target: Edit }) => void): esri.Handle;
