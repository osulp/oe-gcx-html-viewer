...
// Adapted from definitions by @dasa hosted at https://github.com/Esri/jsapi-resources/tree/master/typescript
// Project: http://js.arcgis.com
// Updated: Tue Apr 15 2014

declare module esri {
      import Graphic = esri.Graphic;
      import Geometry = esri.geometry.Geometry;
      import Point = esri.geometry.Point;
      import ScreenPoint = esri.geometry.ScreenPoint;
      import FeatureLayer = esri.layers.FeatureLayer;
      import Map = esri.Map;
      import Layer = esri.layers.Layer;
      import ImageParameters = esri.layers.ImageParameters;
      import ImageServiceParameters = esri.layers.ImageServiceParameters;
      import InfoTemplate = esri.InfoTemplate;
      import Basemap = esri.dijit.Basemap;
      import Extent = esri.geometry.Extent;
      import TileInfo = esri.layers.TileInfo;
      import BasemapLayer = esri.dijit.BasemapLayer;
      import BookmarkItem = esri.dijit.BookmarkItem;
      import Units = esri.Units;
      import PictureMarkerSymbol = esri.symbol.PictureMarkerSymbol;
      import RouteParameters = esri.tasks.RouteParameters;
      import SimpleLineSymbol = esri.symbol.SimpleLineSymbol;
      import Color = esri.Color;
      import Font = esri.symbol.Font;
      import LineSymbol = esri.symbol.LineSymbol;
      import MarkerSymbol = esri.symbol.MarkerSymbol;
      import GraphicsLayer = esri.layers.GraphicsLayer;
      import SpatialReference = esri.SpatialReference;
      import Symbol = esri.symbol.Symbol;
      import InfoWindowBase = esri.InfoWindowBase;
      import LOD = esri.layers.LOD;
      import FillSymbol = esri.symbol.FillSymbol;
      import PrintTemplate = esri.tasks.PrintTemplate;
      import SimpleMarkerSymbol = esri.symbol.SimpleMarkerSymbol;
      import WMTSLayerInfo = esri.layers.WMTSLayerInfo;
      import Attribution = esri.dijit.Attribution;
      import SnappingManager = esri.SnappingManager;
      import TimeExtent = esri.TimeExtent;
      import TimeSlider = esri.dijit.TimeSlider;
      ...
      export interface ArcGISDynamicMapServiceLayerOptions {
        /** export class attribute to set for the layer's node. */
        className?: string;
      ...
      export interface BasemapToggleOptions {
        ...
        map: Map;
        /** export class used for styling the widget. */
        theme?: string;
    ...
    /** The Credential export class represents a credential object used to access a secure ArcGIS resource. */
    ...
    /** The Map export class creates a container and required DOM structure for adding layers, graphics, an info window, and other navigation controls. */
    export class Map {
    ...
    /** This singleton export class is automatically instantiated into esri.id when the module containing this export class is imported into the application. */
    ...
    /** This export class provides the framework and helper methods required to implement a solution for managing user credentials. */
    ...
    /** The base export class for the out-of-the-box InfoWindow. */
    ...
    /** The OperationBase export class defines operations that can be added to the UndoManager. */
    ...
    /** This export class contains information about an ArcGIS Server and its token endpoint. */
    ...
    /** 
     * Converts the URL arguments to an object representation. Legacy location for the function
     * @param url The input URL.
     */
...
declare module esri.arcgis {
  /** The Portal export class is part of the ArcGIS Portal API which provides a way to build applications that work with content from ArcGIS Online or an ArcGIS Portal. */
  export class Portal {
  ...
  /** The PortalFolder export class provides information about folders used to organize content in a portal. */
...
declare module esri.dijit {
  import DirectionsFeatureSet = esri.tasks.DirectionsFeatureSet;
  import Graphic = esri.Graphic;
  import RouteParameters = esri.tasks.RouteParameters;
  import RouteTask = esri.tasks.RouteTask;
  import Point = esri.geometry.Point;
  import RouteResult = esri.tasks.RouteResult;
...
declare module esri.dijit {
  import InfoWindowBase = esri.InfoWindowBase;
  import Point = esri.geometry.Point;
  import InfoWindow = esri.dijit.InfoWindow;
...
declare module esri.dijit {
  ...
  /** The Popup export class is an implementation of InfoWindow that inherits from InfoWindowBase to provide additional capabilities. */
...
declare module esri.dijit {
  ...
  /** The PopupMobile export class is an implementation of InfoWindow that inherits from InfoWindowBase to provide additional capabilities. */
...
declare module esri.dijit {
  ...
  /** The PopupTemplate export class extends esri.InfoTemplate and provides support for defining a layout. */
...
declare module esri.dijit {
  ...
  import AnalysisBase = esri.dijit.analysis.AnalysisBase;
  import Map = esri.Map;
  import FeatureLayer = esri.layers.FeatureLayer;
...
declare module esri.dijit.analysis {
  ...
  /** The AnalysisBase dijit is the base export class for all other dijits under esri.dijit.analysis. */
...
declare module esri.dijit.editing {
  ...
  import OperationBase = esri.OperationBase;
...
declare module esri.dijit.geoenrichment {
  ...
  import GeometryStudyArea = esri.tasks.geoenrichment.GeometryStudyArea;
  import FeatureSet = esri.tasks.FeatureSet;
...
declare module esri.dijit.geoenrichment {
  ...
  import InfographicsOptions = esri.dijit.geoenrichment.InfographicsOptions;
  import GeometryStudyArea = esri.tasks.geoenrichment.GeometryStudyArea;
...
declare module esri.geometry {
  ...
  import Polygon = esri.geometry.Polygon;
  import SpatialReference = esri.SpatialReference;
  import Point = esri.geometry.Point;
...
declare module esri.geometry {
  ...
  /** The base export class for geometry objects. */
...
declare module esri.geometry {
  import Polygon = esri.geometry.Polygon;
  import Geometry = esri.geometry.Geometry;
  import Polyline = esri.geometry.Polyline;
...
declare module esri.geometry {
     ...
     */
    export function fromJson(json: Object): Geometry;
    /**
     ...
     */
    export function getJsonType(geometry: Geometry): string;
}
...
declare module esri.geometry {
  import Geometry = esri.geometry.Geometry;
  import GeometryService = esri.tasks.GeometryService;
...
declare module esri.geometry {
    ...
    /**
        ...
        */
    export function getExtentForScale(map: Map, scale: number): Extent;
    /**
...
declare module esri.geometry {
    ...
    */
    export function geographicToWebMercator(geometry: Geometry): Geometry;
    /**
    ...
    * @param geometry The geometry to convert.
    */
    export function webMercatorToGeographic(geometry: Geometry): Geometry;
    /**
...
declare module esri.layers {
  ...
  import DynamicMapServiceLayer = esri.layers.DynamicMapServiceLayer;
  import DynamicLayerInfo = esri.layers.DynamicLayerInfo;
  import LayerDrawingOptions = esri.layers.LayerDrawingOptions;
  import LayerInfo = esri.layers.LayerInfo;
  import LayerTimeOptions = esri.layers.LayerTimeOptions;
  import TimeInfo = esri.layers.TimeInfo;
  import ImageParameters = esri.layers.ImageParameters;
  import MapImage = esri.layers.MapImage;
...
declare module esri.layers {
  ...
  import DynamicMapServiceLayer = esri.layers.DynamicMapServiceLayer;
  import MosaicRule = esri.layers.MosaicRule;
  import InfoTemplate = esri.InfoTemplate;
  import RasterFunction = esri.layers.RasterFunction;
  import TimeInfo = esri.layers.TimeInfo;
  import ImageServiceParameters = esri.layers.ImageServiceParameters;
  import Graphic = esri.Graphic;
  import Query = esri.tasks.Query;
  import MapImage = esri.layers.MapImage;
...
declare module esri.layers {
  ...
  import TiledMapServiceLayer = esri.layers.TiledMapServiceLayer;
  import LayerInfo = esri.layers.LayerInfo;
  import TimeInfo = esri.layers.TimeInfo;
...
declare module esri.layers {
  import Domain = esri.layers.Domain;
...
declare module esri.layers {
  ...
  /** The base export class for ArcGIS Server dynamic map services. */
...
declare module esri.layers {
  ...
  import GraphicsLayer = esri.layers.GraphicsLayer;
  import Field = esri.layers.Field;
  import Extent = esri.geometry.Extent;
  import Graphic = esri.Graphic;
  import Renderer = esri.renderer.Renderer;
  import FeatureTemplate = esri.layers.FeatureTemplate;
  import TimeInfo = esri.layers.TimeInfo;
  import FeatureType = esri.layers.FeatureType;
  import Symbol = esri.symbol.Symbol;
  import TimeExtent = esri.TimeExtent;
  import Query = esri.tasks.Query;
  import RelationshipQuery = esri.tasks.RelationshipQuery;
  import InfoTemplate = esri.InfoTemplate;
  import FeatureEditResult = esri.layers.FeatureEditResult;
  import FeatureSet = esri.tasks.FeatureSet;
...
declare module esri.layers {
  ...
  /** The GeoRSSLayer export class is used to create a layer based on GeoRSS. */
...
declare module esri.layers {
  ...
  /** Subexport class of esri.layers.Domain. */
...
declare module esri.layers {
  /** The JoinDataSource export class defines and provides information about the result of a join operation. */
...
declare module esri.layers {
  ...
  /** The KMLGroundOverlay export class provides details about a KML ground overlay. */
...
declare module esri.layers {
  ...
  import Layer = esri.layers.Layer;
  import KMLFolder = esri.layers.KMLFolder;

  /** The KMLLayer export class is used to create a layer based on a KML file (.kml,.kmz). */
...
declare module esri.layers {
  import TextSymbol = esri.symbol.TextSymbol;
...
declare module esri.layers {
  import GraphicsLayer = esri.layers.GraphicsLayer;
  import FeatureLayer = esri.layers.FeatureLayer;
  import SimpleRenderer = esri.renderer.SimpleRenderer;
  import UniqueValueRenderer = esri.renderer.UniqueValueRenderer;
  import ClassBreaksRenderer = esri.renderer.ClassBreaksRenderer;
...
declare module esri.layers {
  /** The LayerDataSource export class defines and provides information about a layer created on the fly from a data source. */
...
declare module esri.layers {
  import LabelClass = esri.layers.LabelClass;
  import Renderer = esri.renderer.Renderer;

  /** The LayerDrawingOptions export class provides options for setting ArcGISDynamicMapServiceLayer rendering options. */
...
declare module esri.layers {
  /** The LayerMapSource export class defines and provides information about an existing map service layer. */
...
declare module esri.layers {
  ...
  /** The MapImageLayer export class is used to add georeferenced images to the map. */
...
declare module esri.layers {
  ...
  /** The QueryDataSource export class defines and provides information about a layer or table that is defined by a SQL query. */
...
declare module esri.layers {
  /** The RasterDataSource export class defines and provides information about a file-based raster that resides in a registered raster workspace. */
...
declare module esri.layers {
  /** The TableDataSource export class defines and provides information about a table, feature class, or raster that resides in a registered file geodatabase, SDE or Shapefile workspace. */
  export class TableDataSource {
    /** The name of a table, feature export class or raster that resides in the registered workspace. */
    dataSourceName: string;
...
declare module esri.layers {
  ...
  /** The base export class for all tiled map service layers. */
...
declare module esri.layers {
  import LayerTimeOptions = esri.layers.LayerTimeOptions;
  import TimeExtent = esri.TimeExtent;
  import TimeReference = esri.layers.TimeReference;
...
declare module esri.layers {
  ...
  import DynamicMapServiceLayer = esri.layers.DynamicMapServiceLayer;
  import Extent = esri.geometry.Extent;
  import WMSLayerInfo = esri.layers.WMSLayerInfo;
  import SpatialReference = esri.SpatialReference;
...
declare module esri.layers {
  ...
  /** The WMSLayerInfo export class defines and provides information about layers in a WMS service. */
...
declare module esri.layers {
  ...
  /** The WMTSLayer export class is used to create a layer based on an OGC Web Map Tile Service layer. */
...
declare module esri.layers {
  ...
  /** The WMTSLayerInfo export class defines and provides information about layers in a WMTS service. */
...
declare module esri.layers {
  ...
  /** The WebTiledLayer export class provides a simple way to add non-ArcGIS Server map tiles as a layer to a map. */
...
declare module esri.layers {
  ...
  import Credential = esri.Credential;
  import Map = esri.Map;

  /** The base export class for all layers that can be added to a map. */
  export class Layer {
    /** The URL, when available, where the layer's attribution data is stored. */
    attributionDataUrl: string;
    /** export class attribute of the layer's node. */
    className: string;
...
declare module esri.process {
  ...
  /** The base processor export class provides the generic api for processors and provides an extension point from which developers can create and extend additional processors. */
...
declare module esri.process {
  ...
  import Processor = esri.process.Processor;
  import Point = esri.geometry.Point;
  import Graphic = esri.Graphic;
  import Extent = esri.geometry.Extent;
...
declare module esri.renderer {
  ...
  /** A export class breaks renderer symbolizes each graphic based on the value of some numeric attribute. */
  export class ClassBreaksRenderer extends Renderer {
    /** Attribute field renderer uses to match values. */
    attributeField: string;
    /** To symbolize polygon features with graduated symbols, use backgroundFillSymbol to specify a simple fill symbol to represent polygon features, and use marker symbols of varying sizes in export class breaks to indicate the quantity. */
    backgroundFillSymbol: FillSymbol;
    /** Deprecated at v2.0, use infos instead. */
    breaks: any[];
    /** The classification method used to generate export class breaks. */
    classificationMethod: string;
    /** Each element in the array is an object that provides information about the export class breaks associated with the renderer. */
    infos: any[];
     ...
     * @param attributeField Specify either the attribute field the renderer uses to match values or starting at version 3.3, a function that returns a value to be compared against export class breaks.
     */
    ...
    /** Remove all existing export class breaks for this renderer. */
    clearBreaks(): void;
    /**
    ...
    /**
     * By default, a graphic or feature is considered a match for a export class break if the graphic's attribute value is greater than or equal to its min value and less than its max value.
...
declare module esri.renderer {
  ...
  /** Base export class for the renderers - SimpleRenderer, ClassBreaksRenderer, UniqueValueRenderer. */
...
declare module esri.renderer {
  import Renderer = esri.renderer.Renderer;
  import SymbolAger = esri.renderer.SymbolAger;
  import Graphic = esri.Graphic;
  import Symbol = esri.symbol.Symbol;
...
declare module esri.renderer {
  ...
  /** Time export class breaks ager displays aging by classifying features based on an age range. */
  export class TimeClassBreaksAger extends SymbolAger {
     ...
     * @param infos Each element in the array is an object that describes the export class breaks information.
     */
...
declare module esri.renderer {
  ...
  export class UniqueValueRenderer extends Renderer {
     ...
     * @param graphic The graphic whose rendering and legend information will be returned.
     */
    getUniqueValueInfo(graphic: Graphic): UniqueValueRendererInfo;
    /**
...
declare module esri.symbol {
  ...
  /** The ShieldLabelSymbol is helper export class which designed for drawing image with text over the image. */
...
declare module esri.symbol {
  ...
  export class SimpleFillSymbol extends FillSymbol {
    ...
    constructor(style: string, outline: SimpleLineSymbol, color: dojo.Color);
    /**
...
declare module esri.symbol {
  ...
  export class SimpleMarkerSymbol extends MarkerSymbol {
    ...
    constructor(style: string, size: number, outline: SimpleLineSymbol, color: dojo.Color);
    /**
...
declare module esri.symbol {
  ...
  export class Symbol {
    ...
    setColor(color: dojo.Color): Symbol;
    /** Converts object to its ArcGIS Server JSON representation. */
    toJson(): any;
  }
...
declare module esri.symbol {
  ...
  export class TextSymbol extends Symbol {
    ...
    constructor(text: string, font: Font, color: dojo.Color);
    /**
...
declare module esri.tasks {
  import ClassificationDefinition = esri.tasks.ClassificationDefinition;
  import Symbol = esri.symbol.Symbol;
  import Color = esri.Color;

  /** Define a export class breaks classification scheme used by the GenerateDataTask to generate classes. */
  export class ClassBreaksDefinition extends ClassificationDefinition {
    /** Define a default symbol for the classification. */
    baseSymbol: Symbol;
    /** The number of export class breaks. */
    breakCount: number;
    ...
    colorRamp: Color;
    /** The name of the field that contains the values used to normalize export class breaks when normalizationType is set to 'field'. */
    normalizationField: string;
    /** The type of normalization used to normalize export class breaks. */
    normalizationType: string;
    /** The standard deviation interval. */
    standardDeviationInterval: number;
    /** Creates a new ClassBreaksDefinition object */
    constructor();
    /** Returns an easily serializable object representation of the export class breaks definition. */
    toJson(): any;
  }
...
declare module esri.tasks {
  ...
  /** The super export class for the classification definition objects used by the GenerateRendererTask export class to generate data classes. */
...
declare module esri.tasks {
  import DirectionsFeatureSet = esri.tasks.DirectionsFeatureSet;
  import Point = esri.geometry.Point;
  import NAMessage = esri.tasks.NAMessage;
  import Polygon = esri.geometry.Polygon;
  import Polyline = esri.geometry.Polyline;
  import Graphic = esri.Graphic;
...
declare module esri.tasks {
  ...
  import ClosestFacilityParameters = esri.tasks.ClosestFacilityParameters;
  import ClosestFacilitySolveResult = esri.tasks.ClosestFacilitySolveResult;
...
declare module esri.tasks {
  ...
  export class DataLayer {
    /** Part or all of a feature from feature export class 1 is contained within a feature from feature export class 2. */
    static SPATIAL_REL_CONTAINS: any;
    /** The feature from feature export class 1 crosses a feature from feature export class 2. */
    static SPATIAL_REL_CROSSES: any;
    /** The envelope of feature export class 1 intersects with the envelope of feature export class 2. */
    static SPATIAL_REL_ENVELOPEINTERSECTS: any;
    /** The envelope of the query feature export class intersects the index entry for the target feature class. */
    static SPATIAL_REL_INDEXINTERSECTS: any;
    /** Part of a feature from feature export class 1 is contained in a feature from feature export class 2. */
    static SPATIAL_REL_INTERSECTS: any;
    /** Features from feature export class 1 overlap features in feature export class 2. */
    static SPATIAL_REL_OVERLAPS: any;
    /** The feature from feature export class 1 touches the border of a feature from feature export class 2. */
    static SPATIAL_REL_TOUCHES: any;
    /** The feature from feature export class 1 is completely enclosed by the feature from feature export class 2. */
...
declare module esri.tasks {
  ...
  export class FeatureSet {
     ...
     */
    constructor(json: Object);
    /** Returns an easily serializable object representation of the Feature Set*/
    toJson(): any;
  }
...
declare module esri.tasks {
  ...
  import FindParameters = esri.tasks.FindParameters;
  import FindResult = esri.tasks.FindResult;
...
declare module esri.tasks {
  ...
  import GenerateRendererParameters = esri.tasks.GenerateRendererParameters;
  import Renderer = esri.renderer.Renderer;

  /** The GenerateRendererTask export class creates a renderer based on a classification definition and optional where clause. */
...
declare module esri.tasks {
  ...
  import AreasAndLengthsParameters = esri.tasks.AreasAndLengthsParameters;
  import Polygon = esri.geometry.Polygon;
  import Polyline = esri.geometry.Polyline;
  import BufferParameters = esri.tasks.BufferParameters;
  import Geometry = esri.geometry.Geometry;
  import DistanceParameters = esri.tasks.DistanceParameters;
  import GeneralizeParameters = esri.tasks.GeneralizeParameters;
  import LengthsParameters = esri.tasks.LengthsParameters;
  import OffsetParameters = esri.tasks.OffsetParameters;
  import ProjectParameters = esri.tasks.ProjectParameters;
  import RelationParameters = esri.tasks.RelationParameters;
  import TrimExtendParameters = esri.tasks.TrimExtendParameters;
...
declare module esri.tasks {
  ...
  import SpatialReference = esri.SpatialReference;
  import ImageParameters = esri.layers.ImageParameters;
  import ArcGISDynamicMapServiceLayer = esri.layers.ArcGISDynamicMapServiceLayer;
  import GPMessage = esri.tasks.GPMessage;
  import ParameterValue = esri.tasks.ParameterValue;
  import MapImage = esri.layers.MapImage;
...
declare module esri.tasks {
  ...
  import IdentifyParameters = esri.tasks.IdentifyParameters;
  import IdentifyResult = esri.tasks.IdentifyResult;
...
declare module esri.tasks {
  ...
  import ImageServiceIdentifyParameters = esri.tasks.ImageServiceIdentifyParameters;
  import ImageServiceIdentifyResult = esri.tasks.ImageServiceIdentifyResult;
...
declare module esri.tasks {
  import AlgorithmicColorRamp = esri.tasks.AlgorithmicColorRamp;
...
declare module esri.tasks {
  ...
  import PrintParameters = esri.tasks.PrintParameters;

  /** The PrintTask export class generates a printer-ready version of the map using an Export Web Map Task available with ArGIS Server 10.1 and later. */
...
declare module esri.tasks {
  ...
  import ServiceAreaParameters = esri.tasks.ServiceAreaParameters;
  import ServiceAreaSolveResult = esri.tasks.ServiceAreaSolveResult;
...
declare module esri.tasks {
  /** The StatisticDefinition export class defines the type of statistics, the field used to calculate the statistics and the resulting output field name. */
...
declare module esri.tasks.geoenrichment {
    import StudyArea = esri.tasks.geoenrichment.StudyArea;
...
declare module esri.tasks.geoenrichment {
  import GeographyLevel = esri.tasks.geoenrichment.GeographyLevel;
...
declare module esri.tasks {
  ...
  import SpatialReference = esri.SpatialReference;
  import Point = esri.geometry.Point;
  import AddressCandidate = esri.tasks.AddressCandidate;
...
declare module esri.tasks {
  import Geometry = esri.geometry.Geometry;
  import SpatialReference = esri.SpatialReference;
  import StatisticDefinition = esri.tasks.StatisticDefinition;
  import Symbol = esri.symbol.Symbol;
  import TimeExtent = esri.TimeExtent;
...
declare module esri.toolbars {
  ...
  import SimpleFillSymbol = esri.symbol.SimpleFillSymbol;
  import SimpleLineSymbol = esri.symbol.SimpleLineSymbol;
  import SimpleMarkerSymbol = esri.symbol.SimpleMarkerSymbol;
  import Map = esri.Map;
  import FillSymbol = esri.symbol.FillSymbol;
...
declare module esri.toolbars {
  ...
  /** The Edit toolbar is a helper export class that provides functionality to move graphics or modify individual vertices, i.e., edit the geometry of existing graphics. */
  export class Edit {
...
declare module esri.virtualearth {
  import VEAddress = esri.virtualearth.VEAddress;
  import Extent = esri.geometry.Extent;
  import Point = esri.geometry.Point;
...
declare module esri.virtualearth {
  ...
  import VEGeocodeResult = esri.virtualearth.VEGeocodeResult;
