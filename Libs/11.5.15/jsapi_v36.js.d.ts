...
declare module esri.layers {
    ...
    export class ArcGISImageServiceLayer extends DynamicMapServiceLayer {
        ...
        queryVisibleRasters(query: esri.tasks.Query, options?: any, callback?: Function, errback?: Function): void;
    ...
    export interface Relationship {
        ...
        cardinality: string; // e.g. "esriCardinalityOneToMany"
        composite: boolean;
        keyField: string;
        role: string; // e.g. "esriRelRoleOrigin"
    }
