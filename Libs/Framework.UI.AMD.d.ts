...
declare module "geocortex/framework-ui/FilterableCollection" {
 ...
 */
export class FilterableCollection<T> extends ObservableCollection<T> {
    private _source;
...
declare module "geocortex/framework-ui/LazyObservable" {
...
declare module "geocortex/framework-ui/ObservableCollectionAggregator" {
import { ObservableCollection } from "geocortex/framework/observables";
/**
 ...
 */
export class ObservableCollectionAggregator<T> extends ObservableCollection<T> {
...
declare module "geocortex/framework-ui/PresentableCollection" {
...
export class PresentableCollectionPageShortcut {
 ...
 */
export class PresentableCollection<T> extends FrameworkObject {
 ...
 */
export function localizeObservables(app: Application, libraryId: string, observables: Observable<string>[]): void;
/**
* Localize the given <string> when all libraries are downloaded.
*/
export function localizeString(app: Application, libraryId: string, stringToLocalize: string, callback: (localizedString: string) => void): void;

}
declare module "geocortex/framework-ui/version" {
module geocortex.framework.ui {
    const version = "2.0.0";
}

}
declare module "geocortex/framework-ui/ViewDescriptorInterface" {
import { ViewBase } from "geocortex/framework/ui/ViewBase";
import { Observable } from "geocortex/framework/observables";
export interface ViewDescriptorInterface {
    view: ViewBase;
...
declare module "geocortex/framework-ui/animation/Animation" {
import { AnimationFactory } from "geocortex/framework-ui/animation/AnimationFactory";
import { AnimationKeyframe } from "geocortex/framework-ui/animation/AnimationKeyframe";
import { AnimationFrameCallback } from "geocortex/framework-ui/animation/AnimationFrameCallback";
import { AnimationSequence } from "geocortex/framework-ui/animation/AnimationSequence";
import { Thenable } from "geocortex/framework/Thenable";
import { AnimationEvent } from "geocortex/framework-ui/animation/AnimationEvent";
/**
 ...
 */
export function create(element: HTMLElement, keyframes?: AnimationKeyframe[], frameCallback?: AnimationFrameCallback): AnimationSequence;
/**
 ...
 * @param frameCallback An optional callback to execute after every frame.
 */
export function play(element: HTMLElement, keyframes: AnimationKeyframe[], frameCallback?: AnimationFrameCallback): Thenable<AnimationEvent>;
/**
 ...
 */
export function scheduleForAnimationFrame(delegate: () => void): void;

}
declare module "geocortex/framework-ui/animation/AnimationEvent" {
import { AnimationState } from "geocortex/framework-ui/animation/AnimationState";
import { AnimationKeyframe } from "geocortex/framework-ui/animation/AnimationKeyframe";
/**
...
declare module "geocortex/framework-ui/animation/AnimationFactory" {
import { AnimationProvider } from "geocortex/framework-ui/animation/AnimationProvider";
import { AnimationFrameCallback } from "geocortex/framework-ui/animation/AnimationFrameCallback";
import { AnimationSequence } from "geocortex/framework-ui/animation/AnimationSequence";
/**
...
declare module "geocortex/framework-ui/animation/AnimationFrameCallback" {
import { AnimationEvent } from "geocortex/framework-ui/animation/AnimationEvent";
/**
...
declare module "geocortex/framework-ui/animation/AnimationKeyframe" {
/** Reserved properties on keyframes are not valid CSS names. */
export var reservedKeyframeProperties: string[];
/**
...
declare module "geocortex/framework-ui/animation/AnimationProvider" {
import { AnimationSequence } from "geocortex/framework-ui/animation/AnimationSequence";
import { AnimationKeyframe } from "geocortex/framework-ui/animation/AnimationKeyframe";
import { AnimationEvent } from "geocortex/framework-ui/animation/AnimationEvent";
/**
...
declare module "geocortex/framework-ui/animation/AnimationProviderBase" {
import { AnimationProvider } from "geocortex/framework-ui/animation/AnimationProvider";
import { AnimationSequence } from "geocortex/framework-ui/animation/AnimationSequence";
import { AnimationKeyframe } from "geocortex/framework-ui/animation/AnimationKeyframe";
import { AnimationEvent } from "geocortex/framework-ui/animation/AnimationEvent";
 ...
 * Not implemented.
 */
export class AnimationProviderBase implements AnimationProvider {
    /** @inherited */
...
declare module "geocortex/framework-ui/animation/AnimationSequence" {
import { AnimationState } from "geocortex/framework-ui/animation/AnimationState";
import { AnimationKeyframe } from "geocortex/framework-ui/animation/AnimationKeyframe";
import { AnimationFrameCallback } from "geocortex/framework-ui/animation/AnimationFrameCallback";
import { Deferrable, Thenable } from "geocortex/framework/Thenable";
import { AnimationEvent } from "geocortex/framework-ui/animation/AnimationEvent";
import { AnimationProvider } from "geocortex/framework-ui/animation/AnimationProvider";
/** @private */
export var _activeAnimations: AnimationSequence[];
/**
 ...
 */
export function checkAndRunIdle(): boolean;
/**
 * Schedules an "idle delegate" to be run when there are no more active animations.
 */
export function runWhenIdle(delegate: Function): void;
/**
...
declare module "geocortex/framework-ui/animation/AnimationState" {
/**
...
declare module "geocortex/framework-ui/MultiRegion/MultiRegionView" {
import { ViewBase } from "geocortex/framework/ui/ViewBase";
import { MultiRegionViewModel } from "geocortex/framework-ui/MultiRegion/MultiRegionViewModel";
import { ViewSwitcherViewModel } from "geocortex/framework-ui/ViewSwitcher/ViewSwitcherViewModel";
import { BindingExpression } from "geocortex/framework/ui/BindingExpression";
export class MultiRegionView extends ViewBase {
    viewModel: MultiRegionViewModel;
    attach(viewModel: MultiRegionViewModel): void;
    /**
     ...
     */
    resolveWidget(widgetId: string, context: ViewSwitcherViewModel, binding: BindingExpression): ViewBase;
...
declare module "geocortex/framework-ui/MultiRegion/MultiRegionViewModel" {
import { ViewModelBase } from "geocortex/framework/ui/ViewModelBase";
import { ObservableCollection } from "geocortex/framework/observables";
import { RegionDescriptor } from "geocortex/framework-ui/MultiRegion/RegionDescriptor";
import { ViewSwitcherViewModel } from "geocortex/framework-ui/ViewSwitcher/ViewSwitcherViewModel";
/**
 ...
 */
export class MultiRegionViewModel extends ViewModelBase {
    /**
    ...
    */
     ...
     */
    protected createViewSwitcherViewModel(targetRegion: string): ViewSwitcherViewModel;
    /**
...
declare module "geocortex/framework-ui/MultiRegion/RegionDescriptor" {
import { Observable } from "geocortex/framework/observables";
import { ViewSwitcherViewModel } from "geocortex/framework-ui/ViewSwitcher/ViewSwitcherViewModel";
...
declare module "geocortex/framework-ui/Selector/SelectorItemViewModel" {
import { Observable } from "geocortex/framework/observables";
/**
...
declare module "geocortex/framework-ui/Selector/SelectorView" {
import { ViewBase } from "geocortex/framework/ui/ViewBase";
 ...
 */
export class SelectorView<T> extends ViewBase {
    private _itemViews;
...
declare module "geocortex/framework-ui/Selector/SelectorViewModel" {
import { ViewModelBase } from "geocortex/framework/ui/ViewModelBase";
import { ObservableCollection, Observable } from "geocortex/framework/observables";
import { SelectorItemViewModel } from "geocortex/framework-ui/Selector/SelectorItemViewModel";
import { Application } from "geocortex/framework/application/Application";
import { CollectionChangedArgs } from "geocortex/framework/events/CollectionChangedArgs";
/**
 * View Model for the Selector widget.
 */
export class SelectorViewModel<T> extends ViewModelBase {
    private _underlyingCollection;
    ...
    mobileMode: boolean;
    /**@inherited */
    constructor(app: Application, libraryId: string, singleSelect?: boolean, nativeSelect?: boolean);
    /**
     ...
     */
    handleUnderlyingCollectionChange(changedArgs: CollectionChangedArgs): void;
    /**
...
declare module "geocortex/framework-ui/SplashScreen/SplashScreenView" {
import { ViewBase } from "geocortex/framework/ui/ViewBase";
import { Application } from "geocortex/framework/application/Application";
export class SplashScreenView extends ViewBase {
...
declare module "geocortex/framework-ui/utils/UiUtils" {
import { ViewBase } from "geocortex/framework/ui/ViewBase";
/**
 ...
 */
export function detectBrowserPrefix(userAgent?: string): string;
export function tapToDismissThis(view: ViewBase, onOtherInteracted?: (evt?: Event) => void, onElementInteracted?: (evt?: Event) => void): void;
export function disableTapToDismiss(view: ViewBase): void;

}
declare module "geocortex/framework-ui/ViewContainer/ButtonTabStripView" {
import { ViewBase } from "geocortex/framework/ui/ViewBase";
import { ViewContainerViewModel } from "geocortex/framework-ui/ViewContainer/ViewContainerViewModel";
export class ButtonTabStripView extends ViewBase {
...
declare module "geocortex/framework-ui/ViewContainer/ViewContainerView" {
import { ViewBase } from "geocortex/framework/ui/ViewBase";
import { Observable } from "geocortex/framework/observables";
import { ViewContainerViewModel } from "geocortex/framework-ui/ViewContainer/ViewContainerViewModel";
import { Application } from "geocortex/framework/application/Application";
import { ViewManagerRegionEntry } from "geocortex/framework/ui/ViewManager";
export class ViewContainerView extends ViewBase {
...
declare module "geocortex/framework-ui/ViewContainer/ViewContainerViewClosedEventArgs" {
export class ViewContainerViewClosedEventArgs {
...
declare module "geocortex/framework-ui/ViewContainer/ViewContainerViewModel" {
import { ViewModelBase } from "geocortex/framework/ui/ViewModelBase";
import { Observable, ObservableCollection } from "geocortex/framework/observables";
import { ViewDescriptor } from "geocortex/framework-ui/ViewContainer/ViewDescriptor";
import { ViewBase } from "geocortex/framework/ui/ViewBase";
import { Application } from "geocortex/framework/application/Application";
import { RegionViewHostingEventArgs } from "geocortex/framework/ui/RegionAdapterBase";
export class ViewContainerViewModel extends ViewModelBase {
     ...
     */
    handleViewHosted(args: RegionViewHostingEventArgs): void;
    /**
     * Handles a view being unhosted from the region this container contains.
     */
    handleViewUnhosted(args: RegionViewHostingEventArgs): void;
...
declare module "geocortex/framework-ui/ViewContainer/ViewDescriptor" {
import { ViewDescriptorInterface } from "geocortex/framework-ui/ViewDescriptorInterface";
import { ViewBase } from "geocortex/framework/ui/ViewBase";
import { Observable } from "geocortex/framework/observables";
import { ViewContainerViewModel } from "geocortex/framework-ui/ViewContainer/ViewContainerViewModel";
export class ViewDescriptor implements ViewDescriptorInterface {
    view: ViewBase;
    iconUri: Observable<string>;
    title: Observable<string>;
    containerTitle: Observable<string>;
    ...
    priority: number;
    scrollTop: number;
    constructor(view: ViewBase, vcvm: ViewContainerViewModel);
}

}
declare module "geocortex/framework-ui/ViewSwitcher/ViewSwitcherView" {
import { ViewBase } from "geocortex/framework/ui/ViewBase";
import { ViewDescriptorInterface } from "geocortex/framework-ui/ViewDescriptorInterface";
export class ViewSwitcherView extends ViewBase {
    /**
...
declare module "geocortex/framework-ui/ViewSwitcher/ViewSwitcherViewDescriptor" {
import { ViewDescriptorInterface } from "geocortex/framework-ui/ViewDescriptorInterface";
import { ViewBase } from "geocortex/framework/ui/ViewBase";
import { Observable } from "geocortex/framework/observables";
import { ViewSwitcherViewModel } from "geocortex/framework-ui/ViewSwitcher/ViewSwitcherViewModel";
export class ViewSwitcherViewDescriptor implements ViewDescriptorInterface {
    view: ViewBase;
    title: Observable<string>;
    isActive: Observable<boolean>;
    viewSwitcherViewModel: ViewSwitcherViewModel;
    constructor(view: ViewBase, vsvm: ViewSwitcherViewModel);
}

}
declare module "geocortex/framework-ui/ViewSwitcher/ViewSwitcherViewModel" {
import { ViewModelBase } from "geocortex/framework/ui/ViewModelBase";
import { ObservableCollection, Observable } from "geocortex/framework/observables";
import { ViewDescriptorInterface } from "geocortex/framework-ui/ViewDescriptorInterface";
import { Application } from "geocortex/framework/application/Application";
 ...
 */
export class ViewSwitcherViewModel extends ViewModelBase {
    /**
     ...
     */
    constructor(app: Application, libraryId?: string, targetRegion?: string);
    /**
...
declare module "geocortex/framework-ui/animation/providers/CachedKeyframe" {
import { AnimationKeyframe } from "geocortex/framework-ui/animation/AnimationKeyframe";
/**
...
declare module "geocortex/framework-ui/animation/providers/CssTransitionAnimationProvider" {
import { AnimationProviderBase } from "geocortex/framework-ui/animation/AnimationProviderBase";
import { CachedKeyframe } from "geocortex/framework-ui/animation/providers/CachedKeyframe";
import { AnimationSequence } from "geocortex/framework-ui/animation/AnimationSequence";
import { AnimationKeyframe } from "geocortex/framework-ui/animation/AnimationKeyframe";
import { AnimationEvent } from "geocortex/framework-ui/animation/AnimationEvent";
/**
 ...
 */
export class CssTransitionAnimationProvider extends AnimationProviderBase {
