...
declare module esri {
    ...
    export function filter(object:any, thisObject:any, callback:Function):any;
    ...
    export function request(options?:any, request?:any):dojo.Deferred;
    export function setRequestPreCallback():void;
    ...
    export class Map {
        ...
        centerAndZoom(mapPoint: esri.geometry.Point, levelOrFactor: number): void;
        centerAndZoom(mapPoint: number[], levelOrFactor: number): void;
        centerAt(mapPoint: esri.geometry.Point): void;
        centerAt(mapPoint: number[]): void;
        destroy():void;
        ...
        setExtent(extent:esri.geometry.Extent, fit?:boolean):void;
...
declare module esri.arcgis {
    ...
    export class xxxPortalGroupInvitation {
        accepted: string;
        created: string;
        dateAccepted: string;
        email: string;
        expiration: esri.tasks.Date;
        fromUsername: string;
        groupId: string;
        id: string;
        mustApprove: boolean;
        received: esri.tasks.Date;
        role: string;
        targetId: string;
        targetType: string;
        type: string;
    ...
    export class xxxPortalNotification {
        data: any;
        id: string;
        received: esri.tasks.Date;
        target: string;
...
declare module esri.dijit {
    ...
    export class Directions {
        ...
        addStops(index: number, stops: esri.geometry.Point[]): dojo.Deferred;
        addStops(index: number, stops: string[]): dojo.Deferred;
        ...
        updateStop(index: number, stop: esri.geometry.Point): dojo.Deferred;
        updateStop(index: number, stop: string): dojo.Deferred;
...
declare module esri.layers {
    ...
    export class DynamicMapServiceLayer extends Layer {
        ...
        spatialReference: esri.SpatialReference;
        constructor();
        getImageUrl(callback:Function, extent:esri.geometry.Extent, width:number, height:number):string;
        refresh():void;
    }
    ...
    export class FeatureLayer extends GraphicsLayer {
        ...
        constructor(featureCollectionObject:any, options?:{
            autoGeneralize?: boolean;
            maxAllowableOffset?: number;
            gdbVersion?: string;
            showAttribution?: boolean;
    ...
    export class TiledMapServiceLayer extends Layer {
        ...
        constructor();
        getTileUrl(row:number, column:number, level:number):string;
        refresh():void;
    }
    ...
    export class WMSLayer extends DynamicMapServiceLayer {
        ...
        title: string;
        version: string;
        constructor(url: string, options?: { format?: string; resourceInfo?: any; transparent?: boolean; visibleLayers?: string[]; });
...
declare module esri.toolbars {
    ...
    export class Edit {
        constructor(map:esri.Map, options?:any);
        activate(tool: string, graphic: esri.Graphic, options?: {
